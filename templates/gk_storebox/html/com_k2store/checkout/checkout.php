...
<div id="k2store-checkout" class="k2store checkout">
	<div id="k2store-checkout-content">
  		<h1><?php echo JText::_('K2STORE_CHECKOUT'); ?></h1>
    <div id="checkout">
      <div class="checkout-heading"><span class="gkStep">01</span><?php echo JText::_('K2STORE_CHECKOUT_OPTIONS'); ?></div>
      <div class="checkout-content"></div>
    </div>
    <?php if (!$this->logged) { ?>
    <div id="billing-address">
      <div class="checkout-heading"><span class="gkStep">02</span><span><?php echo JText::_('K2STORE_CHECKOUT_ACCOUNT'); ?></span></div>
      <div class="checkout-content"></div>
    </div>
    <?php } else { ?>
    <div id="billing-address">
      <div class="checkout-heading"><span class="gkStep">02</span><span><?php echo JText::_('K2STORE_CHECKOUT_BILLING_ADDRESS');; ?></span></div>
      <div class="checkout-content"></div>
    </div>
    <?php } ?>
    <?php if ($this->showShipping) { ?>
    <div id="shipping-address">
      <div class="checkout-heading"><span class="gkStep">03</span><?php echo JText::_('K2STORE_CHECKOUT_SHIPPING_ADDRESS'); ?></div>
      <div class="checkout-content"></div>
    </div>
    <?php } ?>
    ...
    <div id="confirm">
      <div class="checkout-heading">
      <?php if ($this->showShipping) : ?>
       <span class="gkStep">05</span>
       <?php echo JText::_('K2STORE_CHECKOUT_CONFIRM'); ?>
      <?php else: ?>
       <span class="gkStep">04</span>
       <?php echo JText::_('K2STORE_CHECKOUT_CONFIRM'); ?>
        <?php endif;?>
...
$(document).on('click', '.checkout-heading a', function() {
	...
	$('.checkout-heading').each(function(i, el) {
		$(el).parent().attr('class', 'done');
	});
...
$(document).ready(function() {
	...
	success: function(html) {
		...
		$('#checkout').attr('class', 'done');
		
		$('#billing-address .checkout-content').slideDown('slow');
		$('#billing-address').attr('class', 'active');
	},
				...
				if (shipping_address) {
					$.ajax({
						...
						success: function(html) {
							...
							$('#billing-address').attr('class', 'done');

							$('#shipping-payment-method .checkout-content').slideDown('slow');
							$('#shipping-payment-method').attr('class', 'active');
					...
					$.ajax({
						...
						success: function(html) {
							...
							$('#shipping-address').attr('class', 'active');
			...
			if (json['redirect']) {
				...
				$.ajax({
					...
					success: function(html) {
						...
						$('#shipping-address').attr('class', 'done');
			...
			if (json['redirect']) {
				...
				$.ajax({
					...
					success: function(html) {
						...
						$('#shipping-payment-method').attr('class', 'done');
