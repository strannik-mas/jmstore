...
<div class="k2store_cartitems">
    ...
    <form action="<?php echo $action; ?>" method="post" name="adminForm" enctype="multipart/form-data">
        ...
        <table id="cart_actions" width="100%">
               ...
               <tr>
               		...
               		<td colspan="2">
               		 <a class="button begin_checkout" href="<?php echo $continue_shopping_url; ?>">
                    ...
                    <td colspan="<?php echo $colspan = isset($continue_shopping_url)?'3':'5';?>">
                        <input style="float: right;" type="submit" class="k2store_cart_button button" value="<?php echo JText::_('K2STORE_UPDATE_QUANTITIES'); ?>" name="update" />
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="5">
				        ...
				        <a class="button begin_checkout" href="<?php echo $checkout_url; ?>">
    ...
    <?php if($this->params->get('enable_coupon', 0) && K2STORE_PRO == 1):?>
		...
		<input type="submit" value="<?php echo JText::_('K2STORE_APPLY_COUPON')?>" class="button" />
		<input type="hidden" name="option" value="com_k2store" />
         <input type="hidden" name="view" value="mycart" />
	    </div>
	     </form>
