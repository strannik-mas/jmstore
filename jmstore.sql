...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 26 2017 г., 20:46
...
--
-- Структура таблицы `vhabe_assets`
--

CREATE TABLE IF NOT EXISTS `vhabe_assets` (
...
--
-- Дамп данных таблицы `vhabe_assets`
--

INSERT INTO `vhabe_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(18, 1, 55, 108, 1, 'com_modules', 'com_modules', '{"core.admin":{"7":1}}'),
...
(56, 11, 34, 35, 2, 'com_languages.language.2', 'Русский (Россия)', '{}'),
(57, 18, 88, 89, 2, 'com_modules.module.88', 'Language Switcher', '{}'),
(58, 16, 48, 49, 2, 'com_menus.menu.2', 'Main Menu (en-GB)', '{}'),
(59, 18, 90, 91, 2, 'com_modules.module.89', 'Main menu en-GB', '{}'),
(60, 8, 20, 23, 2, 'com_content.category.8', 'Category (en-gb)', '{}'),
(61, 60, 21, 22, 3, 'com_content.article.1', 'Article (en-gb)', '{}'),
(62, 16, 50, 51, 2, 'com_menus.menu.3', 'Main Menu (ru-RU)', '{}'),
(63, 18, 92, 93, 2, 'com_modules.module.90', 'Main menu ru-RU', '{}'),
(64, 8, 24, 27, 2, 'com_content.category.9', 'Категория (ru-ru)', '{}'),
(65, 64, 25, 26, 3, 'com_content.article.2', 'Материал (ru-ru)', '{}'),
(66, 1, 139, 140, 1, 'com_jce', 'COM_JCE', '{}'),
(67, 1, 141, 142, 1, 'com_virtuemart', 'VIRTUEMART', '{}'),
(68, 1, 143, 144, 1, 'com_virtuemart_allinone', 'VirtueMart_allinone', '{}'),
(69, 18, 94, 95, 2, 'com_modules.module.91', 'VM - Administrator Module', '{}'),
(70, 18, 96, 97, 2, 'com_modules.module.92', 'VM - Currencies Selector', '{}'),
(71, 18, 98, 99, 2, 'com_modules.module.93', 'VM - Featured products', '{}'),
(72, 18, 100, 101, 2, 'com_modules.module.94', 'VM - Search in Shop', '{}'),
(73, 18, 102, 103, 2, 'com_modules.module.95', 'VM - Manufacturer', '{}'),
(74, 18, 104, 105, 2, 'com_modules.module.96', 'VM - Shopping cart', '{}'),
(75, 18, 106, 107, 2, 'com_modules.module.97', 'VM - Category', '{}'),
(76, 1, 145, 146, 1, 'com_tcpdf', 'tcpdf', '{}');

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_associations`
--

CREATE TABLE IF NOT EXISTS `vhabe_associations` (
...
--
-- Дамп данных таблицы `vhabe_associations`
--

INSERT INTO `vhabe_associations` (`id`, `context`, `key`) VALUES
(1, 'com_content.item', '85f35a3b5a917b9fbcadd24ff9faa5e7'),
(2, 'com_content.item', '85f35a3b5a917b9fbcadd24ff9faa5e7'),
(8, 'com_categories.item', 'dc7cc46e89ead9c75eff3277beb149f0'),
(9, 'com_categories.item', 'dc7cc46e89ead9c75eff3277beb149f0'),
(103, 'com_menus.item', 'f60842035d44af8985d4e3af45165213'),
(105, 'com_menus.item', 'f60842035d44af8985d4e3af45165213');

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_banners`
--

CREATE TABLE IF NOT EXISTS `vhabe_banners` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `vhabe_banner_clients`
--

CREATE TABLE IF NOT EXISTS `vhabe_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Структура таблицы `vhabe_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `vhabe_banner_tracks` (
...
--
-- Структура таблицы `vhabe_categories`
--

CREATE TABLE IF NOT EXISTS `vhabe_categories` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `vhabe_categories`
--

INSERT INTO `vhabe_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 15, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 413, '2017-10-13 09:26:58', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 413, '2017-10-13 09:26:58', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 413, '2017-10-13 09:26:58', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 413, '2017-10-13 09:26:58', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 413, '2017-10-13 09:26:58', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 413, '2017-10-13 09:26:58', 0, '0000-00-00 00:00:00', 0, '*', 1),
(8, 60, 1, 11, 12, 1, 'category-en-gb', 'com_content', 'Category (en-gb)', 'category-en-gb', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 413, '2017-10-13 09:29:27', 0, '2017-10-13 09:29:27', 0, 'en-GB', 1),
(9, 64, 1, 13, 14, 1, 'kategoriya-ru-ru', 'com_content', 'Категория (ru-ru)', 'kategoriya-ru-ru', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 413, '2017-10-13 09:29:27', 0, '2017-10-13 09:29:27', 0, 'ru-RU', 1);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_contact_details`
--

CREATE TABLE IF NOT EXISTS `vhabe_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `vhabe_content`
--

CREATE TABLE IF NOT EXISTS `vhabe_content` (
...
--
-- Дамп данных таблицы `vhabe_content`
--

INSERT INTO `vhabe_content` (`id`, `asset_id`, `title`, `alias`, `introtext`, `fulltext`, `state`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`) VALUES
(1, 61, 'Article (en-gb)', 'article-en-gb', '<p>Lorem ipsum ad his scripta blandit partiendo, eum fastidii accumsan euripidis in, eum liber hendrerit an. Qui ut wisi vocibus suscipiantur, quo dicit ridens inciderint id. Quo mundi lobortis reformidans eu, legimus senseritdefiniebas an eos. Eu sit tincidunt incorrupte definitionem, vis mutat affert percipit cu, eirmod consectetuer signiferumque eu per. In usu latineequidem dolores. Quo no falli viris intellegam, ut fugit veritus placeratper. Ius id vidit volumus mandamus, vide veritus democritum te nec, ei eosdebet libris consulatu.</p>', '', 1, 8, '2017-10-13 09:29:27', 413, 'Joomla', '2017-10-13 09:29:27', 0, 0, '0000-00-00 00:00:00', '2017-10-13 09:29:27', '0000-00-00 00:00:00', '[]', '[]', '{}', 1, 0, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":"","tags":null}', 1, 'en-GB', ''),
(2, 65, 'Материал (ru-ru)', 'material-ru-ru', '<p>Lorem ipsum ad his scripta blandit partiendo, eum fastidii accumsan euripidis in, eum liber hendrerit an. Qui ut wisi vocibus suscipiantur, quo dicit ridens inciderint id. Quo mundi lobortis reformidans eu, legimus senseritdefiniebas an eos. Eu sit tincidunt incorrupte definitionem, vis mutat affert percipit cu, eirmod consectetuer signiferumque eu per. In usu latineequidem dolores. Quo no falli viris intellegam, ut fugit veritus placeratper. Ius id vidit volumus mandamus, vide veritus democritum te nec, ei eosdebet libris consulatu.</p>', '', 1, 9, '2017-10-13 09:29:27', 413, 'Joomla', '2017-10-13 09:29:27', 0, 0, '0000-00-00 00:00:00', '2017-10-13 09:29:27', '0000-00-00 00:00:00', '[]', '[]', '{}', 1, 0, '', '', 1, 3, '{"robots":"","author":"","rights":"","xreference":"","tags":null}', 1, 'ru-RU', '');

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `vhabe_contentitem_tag_map` (
...
--
-- Структура таблицы `vhabe_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `vhabe_content_frontpage` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `ordering` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `vhabe_content_frontpage`
--

INSERT INTO `vhabe_content_frontpage` (`content_id`, `ordering`) VALUES
(1, 0),
(2, 0);
...
--
-- Структура таблицы `vhabe_content_rating`
--

CREATE TABLE IF NOT EXISTS `vhabe_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `vhabe_content_types`
--

CREATE TABLE IF NOT EXISTS `vhabe_content_types` (
...
--
-- Дамп данных таблицы `vhabe_content_types`
--

INSERT INTO `vhabe_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Структура таблицы `vhabe_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `vhabe_core_log_searches` (
...
--
-- Структура таблицы `vhabe_extensions`
--

CREATE TABLE IF NOT EXISTS `vhabe_extensions` (
...
--
-- Дамп данных таблицы `vhabe_extensions`
--

INSERT INTO `vhabe_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2017 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"82d539f82671dcc1dd36d645fce0cd37"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2017 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1507984138}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 0, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{"name":"plg_system_stats","type":"plugin","creationDate":"November 2013","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2017 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_STATS_XML_DESCRIPTION","group":"","filename":"stats"}', '{"mode":3,"lastrun":1507886990,"unique_id":"a8bcd2c20dac311cce53854f6cbcb8b72dc727a7","interval":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10023, 0, 'VM Payment - Realex HPP & API', 'plugin', 'realex_hpp_api', 'vmpayment', 0, 0, 1, 0, '{"name":"realex_hpp_api","type":"plugin","creationDate":"August 23 2017","author":"The VirtueMart Development Team","copyright":"Copyright (C) 2004 - 2017 Virtuemart Team. All rights reserved.","authorEmail":"","authorUrl":"https:\\/\\/virtuemart.net","version":"3.2.4","description":"Realex HPP and API","group":"","filename":"realex_hpp_api"}', '', '', '', 0, '0000-00-00 00:00:00', 3, 0),
...
(10027, 0, 'VM Payment - Sofort iDeal', 'plugin', 'sofort_ideal', 'vmpayment', 0, 0, 1, 0, '{"name":"Sofort Ideal","type":"plugin","creationDate":"August 23 2017","author":"The VirtueMart Development Team","copyright":"Copyright (C) 2004 - 2017 Virtuemart Team. All rights reserved.","authorEmail":"","authorUrl":"https:\\/\\/virtuemart.net","version":"3.2.4","description":"<a href=\\"http:\\/www.sofort.com\\" target=\\"_blank\\">Sofort<\\/a> is a popular\\n\\tpayment provider and available in many countries. \\n    ","group":"","filename":"sofort"}', '', '', '', 0, '0000-00-00 00:00:00', 5, 0),
(10028, 0, 'VM Payment - Klikandpay', 'plugin', 'klikandpay', 'vmpayment', 0, 0, 1, 0, '{"name":"VM Payment - klikandpay","type":"plugin","creationDate":"August 23 2017","author":"The VirtueMart Development Team","copyright":"Copyright (C) 2004 - 2017 Virtuemart Team. All rights reserved.","authorEmail":"","authorUrl":"https:\\/\\/virtuemart.net","version":"3.2.4","description":"<a href=\\"http:\\/\\/klikandpay.com\\" target=\\"_blank\\">klikandpay<\\/a> \\n    ","group":"","filename":"klikandpay"}', '', '', '', 0, '0000-00-00 00:00:00', 10, 0),
...
(10032, 0, 'VM Calculation - Avalara Tax', 'plugin', 'avalara', 'vmcalculation', 0, 0, 1, 0, '{"name":"VM - Calculation Avalara Tax","type":"plugin","creationDate":"August 23 2017","author":"Max Milbers","copyright":"Copyright (C) 2013 iStraxx UG (haftungsbeschr\\u00e4nkt). All rights reserved","authorEmail":"","authorUrl":"https:\\/\\/virtuemart.net","version":"3.2.4","description":"VM - Calculation Avalara Tax; On demand tax calculation for whole U.S.A.","group":"","filename":"avalara"}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10033, 0, 'VirtueMart Product', 'plugin', 'virtuemart', 'search', 0, 1, 1, 0, '{"name":"Search - VirtueMart","type":"plugin","creationDate":"August 23 2017","author":"The VirtueMart Development Team","copyright":"Copyright (C) 2004 - 2017 Virtuemart Team. All rights reserved.","authorEmail":"","authorUrl":"https:\\/\\/virtuemart.net","version":"3.2.4","description":"PLG_SEARCH_VIRTUEMART_XML_DESCRIPTION","group":"","filename":"virtuemart"}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10034, 0, 'VM Framework Loader during Plugin Updates', 'plugin', 'vmLoaderPluginUpdate', 'system', 0, 1, 1, 0, '{"name":"VM Framework Loader during Plugin Updates","type":"plugin","creationDate":"2017-08-06","author":"Reinhold Kainhofer","copyright":"Copyright (C) 2017 Reinhold Kainhofer.","authorEmail":"office@open-tools.net","authorUrl":"http:\\/\\/www.virtuemart.net\\/","version":"1.0","description":"Makes sure the VirtueMart framework is loaded during automatic plugin updates using Joomla''s plugin updater.","group":"","filename":"vmLoaderPluginUpdate"}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10035, 0, 'mod_vmmenu', 'module', 'mod_vmmenu', '', 1, 1, 3, 0, '{"name":"VirtueMart Administrator Menu","type":"module","creationDate":"August 23 2017","author":"The VirtueMart Development Team","copyright":"Copyright (C) 2004-2013 Virtuemart Team. All rights reserved.","authorEmail":"max|at|virtuemart.net","authorUrl":"https:\\/\\/virtuemart.net","version":"3.2.4","description":"MOD_VMMENU_XML_DESCRIPTION","group":"","filename":"mod_vmmenu"}', '', '', '', 0, '0000-00-00 00:00:00', 5, 0),
(10036, 0, 'mod_virtuemart_currencies', 'module', 'mod_virtuemart_currencies', '', 0, 1, 1, 0, '{"name":"mod_virtuemart_currencies","type":"module","creationDate":"August 23 2017","author":"The VirtueMart Development Team","copyright":"Copyright (C) 2004 - 2017 Virtuemart Team. All rights reserved.","authorEmail":"","authorUrl":"https:\\/\\/virtuemart.net","version":"3.2.4","description":"MOD_VIRTUEMART_CURRENCIES_DESC","group":"","filename":"mod_virtuemart_currencies"}', '', '', '', 0, '0000-00-00 00:00:00', 5, 0),
(10037, 0, 'mod_virtuemart_product', 'module', 'mod_virtuemart_product', '', 0, 1, 1, 0, '{"name":"mod_virtuemart_product","type":"module","creationDate":"August 23 2017","author":"The VirtueMart Development Team","copyright":"Copyright (C) 2004 - 2017 Virtuemart Team. All rights reserved.","authorEmail":"","authorUrl":"https:\\/\\/virtuemart.net","version":"3.2.4","description":"MOD_VIRTUEMART_PRODUCT_DESC","group":"","filename":"mod_virtuemart_product"}', '', '', '', 0, '0000-00-00 00:00:00', 3, 0),
(10038, 0, 'mod_virtuemart_search', 'module', 'mod_virtuemart_search', '', 0, 1, 1, 0, '{"name":"mod_virtuemart_search","type":"module","creationDate":"August 23 2017","author":"The VirtueMart Development Team","copyright":"Copyright (C) 2004 - 2017 Virtuemart Team. All rights reserved.","authorEmail":"","authorUrl":"https:\\/\\/virtuemart.net","version":"3.2.4","description":"MOD_VIRTUEMART_SEARCH_DESC","group":"","filename":"mod_virtuemart_search"}', '', '', '', 0, '0000-00-00 00:00:00', 2, 0),
(10039, 0, 'mod_virtuemart_manufacturer', 'module', 'mod_virtuemart_manufacturer', '', 0, 1, 1, 0, '{"name":"mod_virtuemart_manufacturer","type":"module","creationDate":"August 23 2017","author":"The VirtueMart Development Team","copyright":"Copyright (C) 2004 - 2017 Virtuemart Team. All rights reserved.","authorEmail":"","authorUrl":"https:\\/\\/virtuemart.net","version":"3.2.4","description":"MOD_VIRTUEMART_MANUFACTURER_DESC","group":"","filename":"mod_virtuemart_manufacturer"}', '', '', '', 0, '0000-00-00 00:00:00', 8, 0),
(10040, 0, 'mod_virtuemart_cart', 'module', 'mod_virtuemart_cart', '', 0, 1, 1, 0, '{"name":"mod_virtuemart_cart","type":"module","creationDate":"August 23 2017","author":"The VirtueMart Development Team","copyright":"Copyright (C) 2004 - 2017 Virtuemart Team. All rights reserved.","authorEmail":"","authorUrl":"https:\\/\\/virtuemart.net","version":"3.2.4","description":"MOD_VIRTUEMART_CART_DESC","group":"","filename":"mod_virtuemart_cart"}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10041, 0, 'mod_virtuemart_category', 'module', 'mod_virtuemart_category', '', 0, 1, 1, 0, '{"name":"mod_virtuemart_category","type":"module","creationDate":"August 23 2017","author":"The VirtueMart Development Team","copyright":"Copyright (C) 2004 - 2017 Virtuemart Team. All rights reserved.","authorEmail":"","authorUrl":"https:\\/\\/virtuemart.net","version":"3.2.4","description":"MOD_VIRTUEMART_CATEGORY_DESC","group":"","filename":"mod_virtuemart_category"}', '', '', '', 0, '0000-00-00 00:00:00', 4, 0),
(10042, 0, 'com_virtuemart - ru-RU', 'file', 'com_virtuemart-ru-RU', '', 0, 1, 0, 0, '{"name":"com_virtuemart - ru-RU","type":"file","creationDate":"11.10.2017","author":"VirtueMart language team","copyright":"\\u00a9 2008-2017 - compojoom-com. All rights reserved!","authorEmail":"max@virtuemart.net","authorUrl":"https:\\/\\/virtuemart.net","version":"2017-10-11-07-54-31","description":"\\n        This package was auto generated with CTransifex(https:\\/\\/compojoom.com). We''ve grabbed the latest language files for our extension from transifex.com.\\n        Special thanks to our translation team at (https:\\/\\/www.transifex.com\\/projects\\/p\\/virtuemart\\/) for helping with this VirtueMart translation!\\n    ","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10043, 0, 'tcpdf', 'component', 'com_tcpdf', '', 1, 1, 0, 0, '{"name":"tcpdf","type":"component","creationDate":"February 2015","author":"Nicola Asuni, The VirtueMart Development Team","copyright":"Copyright (c) 2001-2013 Nicola Asuni - Tecnick.com LTD - Tutti i diritti riservati - All Rights Reserved. 2015 Virtuemart Team. All rights reserved.","authorEmail":"","authorUrl":"${PHING.VM.MAINTAINERURL}","version":"1.0.4","description":"TCPDF 6.2.12 by Nicola Asuni. Joomla Installer by the VirtueMart Team","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10044, 0, 'PostCalc', 'plugin', 'postcalc', 'vmshipment', 0, 1, 1, 0, '{"name":"PostCalc","type":"plugin","creationDate":"1 November 2014","author":"esmark","copyright":"Copyright (C) 2010-2014 esmark.ru. All rights reserved.","authorEmail":"esmark@mail.ru","authorUrl":"http:\\/\\/www.esmark.ru","version":"1.2.0","description":"PostCalc (Russianpost and EMS-post) Shipment plugin working with postcalc.ru API service.","group":"","filename":"postcalc"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10047, 0, 'gk_storebox', 'template', 'gk_storebox', '', 0, 1, 1, 0, '{"name":"gk_storebox","type":"template","creationDate":"21 May 2014","author":"GavickPro","copyright":"Copyright (C) 2007 - 2014 GavickPro. All rights reserved.","authorEmail":"support@gavick.com","authorUrl":"http:\\/\\/gavick.com","version":"3.11.2","description":"\\n\\t\\t<link rel=\\"stylesheet\\" type=\\"text\\/css\\" href=\\"..\\/templates\\/gk_storebox\\/admin\\/style.css\\" \\/>\\n\\t\\t\\t<style type=\\"text\\/css\\" media=\\"all\\">\\n\\t\\t\\t<!--\\n\\t\\t\\t#wrap1 {padding:0px 0px 4px 0px;}\\n\\t\\t\\t#wrap1 h1 {clear:both;font-family: Georgia, sans-serif;font-size:38px;margin:30px 20px 12px ;padding:0px 0px 24px 10px;color:#333; border-bottom: 1px solid #ccc; font-weight: normal;}\\n\\t\\t\\t#wrap1 h4 { border: none;  margin: 0 0 12px; padding:0; font: italic 20px\\/32px Georgia, sans-serif; color: #333; }\\n\\t\\t\\t#wrap1 sup { font-style: italic; font-size: }\\n\\t\\t\\t.wrap2 {background:#fff;padding: 20px; font-family: Arial; font-size:13px; text-align: justify; color: #4d4d4d; line-height: 24px;}\\n\\t\\t\\t.leftart {margin: 16px 0 0 176px; font-weight:normal!important; }\\n\\t\\t\\t.livedemo { margin-top: 28px; }\\n\\t\\t\\tspan.tooltip-content { display: none; }\\n\\t\\t\\t.tip-text span.readonly { display: none; }\\n\\t\\t\\t.tip-text span.tooltip-content { display: block; }\\n\\t\\t\\t.tip-text #wrap1 { display: none; }\\n\\t\\t\\t-->\\n\\t\\t\\t<\\/style>\\t\\n\\t\\t\\t\\n\\t\\t\\t<div id=\\"wrap1\\">    \\n\\t\\t\\t<h1><em>StoreBox<\\/em><\\/h1>\\n\\t\\t\\t<div class=\\"wrap2\\">                    \\n\\t\\t\\t\\n\\t\\t\\t<a title=\\"Visit the official website!\\" href=\\"http:\\/\\/demo.gavick.com\\/joomla25\\/storebox\\/\\" target=\\"_blank\\"> <img style=\\"padding-left: 10px;float: left; background-color: #fff;\\" src=\\"..\\/templates\\/gk_storebox\\/images\\/template_image.jpg\\" border=\\"0\\" alt=\\"Logo\\" \\/><\\/a>       \\n\\t\\t\\t\\n\\t\\t\\t<div class=\\"leftart\\">            \\n\\t\\t\\t\\n\\t\\t\\t<h4>Use StoreBox template to create a successful online store! <\\/h4>\\n\\t\\t\\t\\n\\t\\t\\t<p>Convince customers to buy your products online, make purchasing simple and allow them  to do the shopping through your Joomla! website!<br \\/>\\n\\t\\t\\t As nowadays selling is conducted over electronic systems, create an outstanding online store and earn a fortune by running a business with StoreBox that will help you to achieve a success and increase the number of customers.<\\/p>\\n\\t\\t\\t<p> This stylish eCommerce Joomla template supports a VirtueMart component that allows to make purchase online. It''s worth mentioning that Responsive Web Design support makes this eCoomerce templatemore attractive and useful as it displays perfectly on any mobile devices!<\\/p>\\n\\t\\t\\t<p> To make it more desirable and catchy, we have used News Show Pro GK5 with two new portal modes, as well as, Image Show GK4 in this Joomla! template. The new portal modes were prepared in order to enhance the most important content on eCommerce pages. <\\/p>\\n\\t\\t\\t<p>What is also interesting, a portal mode with products allows to change slides by \\"swipe left\\/right\\" gesture on touch screens. It''s a perfect solution while building a responsive website, isn''t it?! <\\/p>\\n\\t\\t\\t<p> Catch up with the latest trends - build an online store with Storebox and be successful in your branch! <\\/p>\\n\\t\\t\\t\\n\\t\\t\\t\\n\\t\\t\\t<p class=\\"livedemo\\">View StoreBox template in action <a href=\\"http:\\/\\/demo.gavick.com\\/joomla25\\/storebox\\/\\" target=\\"_blank\\">here<\\/a>...<\\/p><small>Gavern v.3.11.2<\\/small><\\/div>\\n\\t\\t\\t<\\/div> \\n\\t\\t\\t<\\/div><span class=\\"tooltip-content\\">Use StoreBox template to create a successful online store! <\\/span>\\n\\t","group":"","filename":"templateDetails"}', '{"template_color":"1","default_layout":"default","template_width":"1230","tablet_width":"1024","tablet_small_width":"820","mobile_width":"580","sidebar_position":"right","sidebar_width":"30","rwd":"1","logo_type":"image","logo_image":"","logo_text":"","logo_slogan":"","print_logo":"","print_behaviour":"1","favicon_image":"","touch_image":"","stylearea":"1","framework_logo":"1","webmaster_contact_type":"1","webmaster_contact":"webmaster@gavick.com","typography":"0","typo_iconset":"0","tools":"1","show_menu":"1","startlevel":"0","endlevel":"-1","menu_animation":"slide","menu_height":"0","menu_width":"0","menu_col_width":"200","menu_duration":"500","fb_api_id":"","fb_lang":"en_US","fb_login":"0","fb_like":"0","fb_like_send":"0","fb_like_layout":"standard","fb_like_show_faces":"true","fb_like_width":"500","fb_like_action":"like","fb_like_font":"arial","fb_like_colorscheme":"light","google_plus":"1","google_plus_count":"1","google_plus_size":"medium","google_plus_lang":"en-GB","google_plus_share":"1","google_plus_share_annotation":"vertical-bubble","google_plus_share_size":"20","tweet_btn":"0","tweet_btn_data_count":"vertical","tweet_btn_data_via":"","tweet_btn_data_lang":"en","pinterest_btn":"0","pinterest_btn_style":"horizontal","excluded_cats":"","cookie_consent":"0","consenttype":"explicit","cookie_latest_version":"0","cookie_use_ssl":"0","banner_position":"bottom","banner_tag_placement":"bottom-right","cookie_style":"light","refreshOnConsent":"0","cookiecss":"1","use_gk_cache":"0","css_cache":"0","css_compression":"0","css_override":"0","css_prefixer":"0","js_compression":"0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10048, 0, 'Button - GK Typography', 'plugin', 'gk_typography', 'editors-xtd', 0, 1, 1, 0, '{"name":"Button - GK Typography","type":"plugin","creationDate":"23\\/10\\/2013","author":"Robert Gavick - GavickPro","copyright":"Copyrighted Commercial Software","authorEmail":"info@gavick.com","authorUrl":"http:\\/\\/www.gavick.com","version":"1.0.3","description":"Plugin to easier typography using in Joomla WYSIWYG editors.","group":"","filename":"gk_typography"}', '[]', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10049, 0, 'System - GK Open Graph Article Parameters', 'plugin', 'plg_gk_opengraph', 'system', 0, 1, 1, 0, '{"name":"System - GK Open Graph Article Parameters","type":"plugin","creationDate":"23 Oct 2013","author":"www.gavick.com","copyright":"All Rights Reserved.","authorEmail":"test@gavick.com","authorUrl":"http:\\/\\/www.gavick.com","version":"1.0.1","description":"Plugin which adds additional article options for GavickPro templates","group":"","filename":"plg_gk_opengraph"}', '{"og:title":"","og:type":"website","og:image":"","og:site_name":"","og:description":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10050, 0, 'GK Menu Extended Parameters', 'plugin', 'gkextmenu', 'system', 0, 1, 1, 0, '{"name":"GK Menu Extended Parameters","type":"plugin","creationDate":"29 December 2010","author":"www.gavick.com","copyright":"All Rights Reserved.","authorEmail":"support@gavick.com","authorUrl":"http:\\/\\/www.gavick.com","version":"1.0","description":"Plugin which adds additional menu options for GavickPro templates","group":"","filename":"gkextmenu"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10051, 0, 'System - GK Cache', 'plugin', 'plg_gkcache', 'system', 0, 0, 1, 0, '{"name":"System - GK Cache","type":"plugin","creationDate":"25 August 2011","author":"www.gavick.com","copyright":"All Rights Reserved.","authorEmail":"test@gavick.com","authorUrl":"http:\\/\\/www.gavick.com","version":"1.0","description":"Plugin necessary if you''re using Joomla! cache for GavickPro templates","group":"","filename":"plg_gkcache"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10052, 0, 'GK Module Title Links', 'plugin', 'plg_gkmodulelinks', 'system', 0, 1, 1, 0, '{"name":"GK Module Title Links","type":"plugin","creationDate":"29 July 2012","author":"www.gavick.com","copyright":"All Rights Reserved.","authorEmail":"test@gavick.com","authorUrl":"http:\\/\\/www.gavick.com","version":"1.0","description":"Plugin which adds additional module options for module titles in GavickPRO Templates.","group":"","filename":"plg_gkmodulelinks"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_fields`
--

CREATE TABLE IF NOT EXISTS `vhabe_fields` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_fields_categories`
--

CREATE TABLE IF NOT EXISTS `vhabe_fields_categories` (
...
--
-- Структура таблицы `vhabe_fields_groups`
--

CREATE TABLE IF NOT EXISTS `vhabe_fields_groups` (
  `id` int(10) unsigned NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Структура таблицы `vhabe_fields_values`
--

CREATE TABLE IF NOT EXISTS `vhabe_fields_values` (
...
--
-- Структура таблицы `vhabe_finder_filters`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_filters` (
...
--
-- Структура таблицы `vhabe_finder_links`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_links` (
...
--
-- Структура таблицы `vhabe_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `vhabe_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `vhabe_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `vhabe_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `vhabe_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `vhabe_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `vhabe_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `vhabe_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `vhabe_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `vhabe_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `vhabe_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `vhabe_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `vhabe_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `vhabe_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `vhabe_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `vhabe_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Дамп данных таблицы `vhabe_finder_taxonomy`
--

INSERT INTO `vhabe_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_finder_terms`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_terms` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Дамп данных таблицы `vhabe_finder_terms_common`
--

INSERT INTO `vhabe_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Структура таблицы `vhabe_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `vhabe_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_finder_types`
--

CREATE TABLE IF NOT EXISTS `vhabe_finder_types` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_languages`
--

CREATE TABLE IF NOT EXISTS `vhabe_languages` (
...
--
-- Дамп данных таблицы `vhabe_languages`
--

INSERT INTO `vhabe_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
--
-- Структура таблицы `vhabe_menu`
--

CREATE TABLE IF NOT EXISTS `vhabe_menu` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `vhabe_menu`
--

INSERT INTO `vhabe_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(7, 'main', 'com_contact', 'Contacts', '', 'Contacts', 'index.php?option=com_contact', 'component', 1, 1, 1, 8, 0, '0000-00-00 00:00:00', 0, 0, 'class:contact', 0, '', 37, 42, 0, '*', 1),
(8, 'main', 'com_contact_contacts', 'Contacts', '', 'Contacts/Contacts', 'index.php?option=com_contact', 'component', 1, 7, 2, 8, 0, '0000-00-00 00:00:00', 0, 0, 'class:contact', 0, '', 38, 39, 0, '*', 1),
(9, 'main', 'com_contact_categories', 'Categories', '', 'Contacts/Categories', 'index.php?option=com_categories&extension=com_contact', 'component', 1, 7, 2, 6, 0, '0000-00-00 00:00:00', 0, 0, 'class:contact-cat', 0, '', 40, 41, 0, '*', 1),
(10, 'main', 'com_messages', 'Messaging', '', 'Messaging', 'index.php?option=com_messages', 'component', 1, 1, 1, 15, 0, '0000-00-00 00:00:00', 0, 0, 'class:messages', 0, '', 43, 46, 0, '*', 1),
(11, 'main', 'com_messages_add', 'New Private Message', '', 'Messaging/New Private Message', 'index.php?option=com_messages&task=message.add', 'component', 1, 10, 2, 15, 0, '0000-00-00 00:00:00', 0, 0, 'class:messages-add', 0, '', 44, 45, 0, '*', 1),
...
(101, 'mainmenu', 'Главная', 'home', '', 'home', 'index.php?option=com_virtuemart&view=virtuemart', 'component', -2, 1, 1, 10011, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_image_css":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"1","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 15, 16, 0, '*', 0),
...
(103, 'mainmenu-en-gb', 'Home', 'home-en-gb', '', 'home-en-gb', 'index.php?option=com_content&view=category&layout=blog&id=8', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"layout_type":"blog","show_category_heading_title_text":"","show_category_title":"","show_description":"","show_description_image":"","maxLevel":"","show_empty_categories":"","show_no_articles":"","show_subcat_desc":"","show_cat_num_articles":"","show_cat_tags":"","page_subheading":"","num_leading_articles":"1","num_intro_articles":"3","num_columns":"3","num_links":"0","multi_column_order":"1","show_subcategory_content":"","orderby_pri":"","orderby_sec":"front","order_date":"","show_pagination":"2","show_pagination_results":"1","show_featured":"","show_title":"","link_titles":"","show_intro":"","info_block_position":"","info_block_show_title":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_associations":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_tags":"","show_noauth":"","show_feed_link":"1","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_image_css":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"1","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":""}', 69, 70, 1, 'en-GB', 0),
(104, 'mainmenu-ru-ru', 'Категории', 'allcategories-ru-ru', '', 'allcategories-ru-ru', 'index.php?option=com_content&view=categories&id=0', 'component', 0, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"show_base_description":"","categories_description":"","maxLevelcat":"","show_empty_categories_cat":"","show_subcat_desc_cat":"","show_cat_num_articles_cat":"","show_category_title":"","show_description":"","show_description_image":"","maxLevel":"","show_empty_categories":"","show_no_articles":"","show_subcat_desc":"","show_cat_num_articles":"","num_leading_articles":"","num_intro_articles":"","num_columns":"","num_links":"","multi_column_order":"","show_subcategory_content":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination_limit":"","filter_field":"","show_headings":"","list_show_date":"","date_format":"","list_show_hits":"","list_show_author":"","display_num":"10","show_pagination":"","show_pagination_results":"","article_layout":"_:default","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_image_css":"","menu_text":1,"menu_show":0,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 25, 26, 1, 'ru-RU', 0),
(105, 'mainmenu-ru-ru', 'Главная', 'home-ru-ru', '', 'home-ru-ru', 'index.php?option=com_virtuemart&view=virtuemart', 'component', 1, 1, 1, 10011, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_image_css":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"1","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 21, 22, 0, 'ru-RU', 0),
(106, 'main', 'COM_JCE', 'com-jce', '', 'com-jce', 'index.php?option=com_jce', 'component', 1, 1, 1, 10003, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/logo.png', 0, '{}', 71, 78, 0, '', 1),
(107, 'main', 'COM_JCE_MENU_CPANEL', 'com-jce-menu-cpanel', '', 'com-jce/com-jce-menu-cpanel', 'index.php?option=com_jce', 'component', 1, 106, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 72, 73, 0, '', 1),
(108, 'main', 'COM_JCE_MENU_CONFIG', 'com-jce-menu-config', '', 'com-jce/com-jce-menu-config', 'index.php?option=com_jce&view=config', 'component', 1, 106, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 74, 75, 0, '', 1),
(109, 'main', 'COM_JCE_MENU_PROFILES', 'com-jce-menu-profiles', '', 'com-jce/com-jce-menu-profiles', 'index.php?option=com_jce&view=profiles', 'component', 1, 106, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 76, 77, 0, '', 1),
(110, 'main', 'COM_VIRTUEMART', 'com-virtuemart', '', 'com-virtuemart', 'index.php?option=com_virtuemart', 'component', 1, 1, 1, 10011, 0, '0000-00-00 00:00:00', 0, 1, '../components/com_virtuemart/assets/images/vmgeneral/menu_icon.png', 0, '{}', 79, 104, 0, '', 1),
(111, 'main', 'COM_VIRTUEMART_CONTROL_PANEL', 'com-virtuemart-control-panel', '', 'com-virtuemart/com-virtuemart-control-panel', 'index.php?option=com_virtuemart&view=virtuemart', 'component', 1, 110, 2, 10011, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_virtuemart/assets/images/icon_16/menu-icon16-report.png', 0, '{}', 80, 81, 0, '', 1),
(112, 'main', 'COM_VIRTUEMART_MENU_CATEGORIES', 'com-virtuemart-menu-categories', '', 'com-virtuemart/com-virtuemart-menu-categories', 'index.php?option=com_virtuemart&view=category', 'component', 1, 110, 2, 10011, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_virtuemart/assets/images/icon_16/menu-icon16-categories.png', 0, '{}', 82, 83, 0, '', 1),
(113, 'main', 'COM_VIRTUEMART_MENU_PRODUCTS', 'com-virtuemart-menu-products', '', 'com-virtuemart/com-virtuemart-menu-products', 'index.php?option=com_virtuemart&view=product', 'component', 1, 110, 2, 10011, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_virtuemart/assets/images/icon_16/menu-icon16-products.png', 0, '{}', 84, 85, 0, '', 1),
(114, 'main', 'COM_VIRTUEMART_MENU_ORDERS', 'com-virtuemart-menu-orders', '', 'com-virtuemart/com-virtuemart-menu-orders', 'index.php?option=com_virtuemart&view=orders', 'component', 1, 110, 2, 10011, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_virtuemart/assets/images/icon_16/menu-icon16-orders.png', 0, '{}', 86, 87, 0, '', 1),
(115, 'main', 'COM_VIRTUEMART_MENU_REPORT', 'com-virtuemart-menu-report', '', 'com-virtuemart/com-virtuemart-menu-report', 'index.php?option=com_virtuemart&view=report', 'component', 1, 110, 2, 10011, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_virtuemart/assets/images/icon_16/menu-icon16-report.png', 0, '{}', 88, 89, 0, '', 1),
(116, 'main', 'COM_VIRTUEMART_MENU_USERS', 'com-virtuemart-menu-users', '', 'com-virtuemart/com-virtuemart-menu-users', 'index.php?option=com_virtuemart&view=user', 'component', 1, 110, 2, 10011, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_virtuemart/assets/images/icon_16/menu-icon16-shoppers.png', 0, '{}', 90, 91, 0, '', 1),
(117, 'main', 'COM_VIRTUEMART_MENU_MANUFACTURERS', 'com-virtuemart-menu-manufacturers', '', 'com-virtuemart/com-virtuemart-menu-manufacturers', 'index.php?option=com_virtuemart&view=manufacturer', 'component', 1, 110, 2, 10011, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_virtuemart/assets/images/icon_16/menu-icon16-manufacturers.png', 0, '{}', 92, 93, 0, '', 1),
(118, 'main', 'COM_VIRTUEMART_MENU_STORE', 'com-virtuemart-menu-store', '', 'com-virtuemart/com-virtuemart-menu-store', 'index.php?option=com_virtuemart&view=user&task=editshop', 'component', 1, 110, 2, 10011, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_virtuemart/assets/images/icon_16/menu-icon16-shop.png', 0, '{}', 94, 95, 0, '', 1),
(119, 'main', 'COM_VIRTUEMART_MENU_MEDIAFILES', 'com-virtuemart-menu-mediafiles', '', 'com-virtuemart/com-virtuemart-menu-mediafiles', 'index.php?option=com_virtuemart&view=media', 'component', 1, 110, 2, 10011, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_virtuemart/assets/images/icon_16/menu-icon16-media.png', 0, '{}', 96, 97, 0, '', 1),
(120, 'main', 'COM_VIRTUEMART_MENU_SHIPMENTMETHODS', 'com-virtuemart-menu-shipmentmethods', '', 'com-virtuemart/com-virtuemart-menu-shipmentmethods', 'index.php?option=com_virtuemart&view=shipmentmethod', 'component', 1, 110, 2, 10011, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_virtuemart/assets/images/icon_16/menu-icon16-shipmentmethods.png', 0, '{}', 98, 99, 0, '', 1),
(121, 'main', 'COM_VIRTUEMART_MENU_PAYMENTMETHODS', 'com-virtuemart-menu-paymentmethods', '', 'com-virtuemart/com-virtuemart-menu-paymentmethods', 'index.php?option=com_virtuemart&view=paymentmethod', 'component', 1, 110, 2, 10011, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_virtuemart/assets/images/icon_16/menu-icon16-paymentmethods.png', 0, '{}', 100, 101, 0, '', 1),
(122, 'main', 'COM_VIRTUEMART_MENU_CONFIGURATION', 'com-virtuemart-menu-configuration', '', 'com-virtuemart/com-virtuemart-menu-configuration', 'index.php?option=com_virtuemart&view=config', 'component', 1, 110, 2, 10011, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_virtuemart/assets/images/icon_16/menu-icon16-config.png', 0, '{}', 102, 103, 0, '', 1),
(123, 'main', 'VirtueMart AIO', 'virtuemart-aio', '', 'virtuemart-aio', 'index.php?option=com_virtuemart_allinone', 'component', 1, 1, 1, 10012, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 105, 106, 0, '', 1),
(124, 'main', 'TCPDF', 'tcpdf', '', 'tcpdf', 'index.php?option=com_tcpdf', 'component', 1, 1, 1, 10043, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 107, 108, 0, '', 1),
(125, 'mainmenu', 'Корзина', 'korzina', '', 'korzina', 'index.php?option=com_virtuemart&view=cart', 'component', -2, 1, 1, 10011, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_image_css":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 35, 36, 0, '*', 0),
(126, 'mainmenu', 'Категории товара', 'kategorii-tovara', '', 'kategorii-tovara', 'index.php?option=com_virtuemart&view=category&virtuemart_category_id=0&virtuemart_manufacturer_id=0', 'component', -2, 1, 1, 10011, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"show_store_desc":"","categorylayout":"","showcategory_desc":"","showcategory":"","categories_per_row":"","showproducts":"","showsearch":"","productsublayout":"","products_per_row":"","featured":"","featured_rows":"","discontinued":"","discontinued_rows":"","latest":"","latest_rows":"","topten":"","topten_rows":"","recent":"","recent_rows":"","stf_itemid":"","stf_categorylayout":"","stf_show_store_desc":"","stf_showcategory_desc":"","stf_showcategory":"","stf_categories_per_row":"","stf_showproducts":"","stf_showsearch":"","stf_productsublayout":"","stf_products_per_row":"","stf_featured":"","stf_featured_rows":"","stf_discontinued":"","stf_discontinued_rows":"","stf_latest":"","stf_latest_rows":"","stf_topten":"","stf_topten_rows":"","stf_recent":"","stf_recent_rows":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_image_css":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 31, 32, 0, '*', 0),
(127, 'mainmenu', 'Наши поставщики', 'nashi-postavshchiki', '', 'nashi-postavshchiki', 'index.php?option=com_virtuemart&view=manufacturer', 'component', -2, 1, 1, 10011, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_image_css":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 33, 34, 0, '*', 0),
(128, 'mainmenu-ru-ru', 'Наши поставщики', 'postavshchiki', '', 'postavshchiki', 'index.php?option=com_virtuemart&view=manufacturer', 'component', 1, 1, 1, 10011, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_image_css":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 27, 28, 0, '*', 0),
(129, 'mainmenu-ru-ru', 'Корзина', 'corzina', '', 'corzina', 'index.php?option=com_virtuemart&view=cart', 'component', 1, 1, 1, 10011, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_image_css":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 29, 30, 0, '*', 0),
(130, 'mainmenu-ru-ru', 'Категории товара', 'categories', '', 'categories', 'index.php?option=com_virtuemart&view=category&virtuemart_category_id=0&virtuemart_manufacturer_id=0', 'component', 1, 1, 1, 10011, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"show_store_desc":"","categorylayout":"","showcategory_desc":"","showcategory":"","categories_per_row":"","showproducts":"","showsearch":"","productsublayout":"","products_per_row":"","featured":"","featured_rows":"","discontinued":"","discontinued_rows":"","latest":"","latest_rows":"","topten":"","topten_rows":"","recent":"","recent_rows":"","stf_itemid":"","stf_categorylayout":"","stf_show_store_desc":"","stf_showcategory_desc":"","stf_showcategory":"","stf_categories_per_row":"","stf_showproducts":"","stf_showsearch":"","stf_productsublayout":"","stf_products_per_row":"","stf_featured":"","stf_featured_rows":"","stf_discontinued":"","stf_discontinued_rows":"","stf_latest":"","stf_latest_rows":"","stf_topten":"","stf_topten_rows":"","stf_recent":"","stf_recent_rows":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_image_css":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 23, 24, 0, '*', 0),
(131, 'mainmenu', 'Категории', 'allcategories-ru-ru-2', '', 'allcategories-ru-ru-2', 'index.php?option=com_virtuemart&view=category&virtuemart_category_id=0&virtuemart_manufacturer_id=0', 'component', 1, 1, 1, 10011, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"show_store_desc":"","categorylayout":"","showcategory_desc":"","showcategory":"","categories_per_row":"","showproducts":"","showsearch":"","productsublayout":"","products_per_row":"","featured":"","featured_rows":"","discontinued":"","discontinued_rows":"","latest":"","latest_rows":"","topten":"","topten_rows":"","recent":"","recent_rows":"","stf_itemid":"","stf_categorylayout":"","stf_show_store_desc":"","stf_showcategory_desc":"","stf_showcategory":"","stf_categories_per_row":"","stf_showproducts":"","stf_showsearch":"","stf_productsublayout":"","stf_products_per_row":"","stf_featured":"","stf_featured_rows":"","stf_discontinued":"","stf_discontinued_rows":"","stf_latest":"","stf_latest_rows":"","stf_topten":"","stf_topten_rows":"","stf_recent":"","stf_recent_rows":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_image_css":"","menu_text":1,"menu_show":0,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 13, 14, 0, 'ru-RU', 0),
(132, 'mainmenu', 'Наши поставщики', 'postavshchiki-2', '', 'postavshchiki-2', 'index.php?option=com_virtuemart&view=manufacturer', 'component', 1, 1, 1, 10011, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_image_css":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 17, 18, 0, '*', 0),
(133, 'mainmenu', 'Корзина', 'corzina-2', '', 'corzina-2', 'index.php?option=com_virtuemart&view=cart', 'component', 1, 1, 1, 10011, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_image_css":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 19, 20, 0, '*', 0),
(134, 'mainmenu', 'Главная', 'home-ru-ru-2', '', 'home-ru-ru-2', 'index.php?option=com_virtuemart&view=virtuemart', 'component', 1, 1, 1, 10011, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_image_css":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"1","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 11, 12, 1, '*', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_menu_types`
--

CREATE TABLE IF NOT EXISTS `vhabe_menu_types` (
  `id` int(10) unsigned NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы `vhabe_menu_types`
--

INSERT INTO `vhabe_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
...
--
-- Структура таблицы `vhabe_messages`
--

CREATE TABLE IF NOT EXISTS `vhabe_messages` (
...
--
-- Структура таблицы `vhabe_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `vhabe_messages_cfg` (
...
--
-- Структура таблицы `vhabe_modules`
--

CREATE TABLE IF NOT EXISTS `vhabe_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Дамп данных таблицы `vhabe_modules`
--

INSERT INTO `vhabe_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 39, 'Main Menu', '', '', 1, 'position-7', 0, '0000-00-00 00:00:00', '2017-10-13 16:59:52', '0000-00-00 00:00:00', 0, 'mod_menu', 1, 1, '{"menutype":"mainmenu","startLevel":"0","endLevel":"0","showAllChildren":"1","tag_id":"","class_sfx":"","window_open":"","layout":"","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
...
(16, 50, 'Login Form', '', '', 2, 'sidebar', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_login', 1, 1, '{"pretext":"","posttext":"","login":"","logout":"","greeting":"1","name":"0","profilelink":"0","usesecure":"0","usetext":"0","layout":"_:default","moduleclass_sfx":"dark","cache":"0","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0","module_link_switch":"0","module_link":""}', 0, '*'),
(17, 51, 'Breadcrumbs', '', '', 1, 'breadcrumb', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_breadcrumbs', 1, 1, '{"showHere":"1","showHome":"0","homeText":"","showLast":"1","separator":"","layout":"_:default","moduleclass_sfx":"","cache":"0","cache_time":"0","cachemode":"itemid","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0","module_link_switch":"0","module_link":""}', 0, '*'),
...
(88, 57, 'Language Switcher', '', '', 0, 'position-0', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_languages', 1, 0, '{"header_text":"","footer_text":"","dropdown":"0","image":"1","inline":"1","show_active":"1","full_name":"1","layout":"_:default","moduleclass_sfx":"","cache":"0","cache_time":"900","cachemode":"itemid","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
(89, 59, 'Main menu en-GB', '', '', 0, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"mainmenu-en-gb","startLevel":"0","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, 'en-GB'),
(90, 63, 'Main menu ru-RU', '', '', 1, 'position-1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"mainmenu-ru-ru","base":"","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, 'ru-RU'),
(91, 69, 'VM - Administrator Module', '', '', 5, 'menu', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_vmmenu', 3, 1, '', 1, '*'),
(92, 70, 'VM - Currencies Selector', '', '', 5, 'position-4', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_virtuemart_currencies', 1, 1, '', 0, '*'),
(93, 71, 'VM - Featured products', '', '', 3, 'position-4', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_virtuemart_product', 1, 1, '', 0, '*'),
(94, 72, 'VM - Search in Shop', '', '', 1, 'search', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_virtuemart_search', 1, 1, '{"width":"20","text":"","filter_category":"0","button":"0","button_pos":"right","imagebutton":"0","image_button_file":"","button_text":"","set_itemid":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0","module_link_switch":"0","module_link":""}', 0, '*'),
(95, 73, 'VM - Manufacturer', '', '', 8, 'position-4', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_virtuemart_manufacturer', 1, 1, '', 0, '*'),
(96, 74, 'VM - Shopping cart', '', '', 1, 'cart', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_virtuemart_cart', 1, 1, '{"moduleid_sfx":"","moduleclass_sfx":"","show_price":"1","show_product_list":"1","layout":"_:default","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0","module_link_switch":"0","module_link":""}', 0, '*'),
(97, 75, 'VM - Category', '', '', 1, 'sidebar', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_virtuemart_category', 1, 1, '{"Parent_Category_id":"0","level":"2","layout":"_:all","cache":"0","moduleclass_sfx":"menu","class_sfx":"","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0","module_link_switch":"0","module_link":""}', 0, '*');

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_modules_menu`
--

CREATE TABLE IF NOT EXISTS `vhabe_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `vhabe_modules_menu`
--

INSERT INTO `vhabe_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Структура таблицы `vhabe_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `vhabe_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_overrider`
--

CREATE TABLE IF NOT EXISTS `vhabe_overrider` (
...
--
-- Структура таблицы `vhabe_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `vhabe_postinstall_messages` (
...
--
-- Дамп данных таблицы `vhabe_postinstall_messages`
--

INSERT INTO `vhabe_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Структура таблицы `vhabe_redirect_links`
--

CREATE TABLE IF NOT EXISTS `vhabe_redirect_links` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_schemas`
--

CREATE TABLE IF NOT EXISTS `vhabe_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `vhabe_schemas`
--

INSERT INTO `vhabe_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.8.0-2017-07-31');

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_session`
--

CREATE TABLE IF NOT EXISTS `vhabe_session` (
...
--
-- Дамп данных таблицы `vhabe_session`
--

INSERT INTO `vhabe_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('l0l6gl97860u2bhfra46fnpvj6', 1, 0, '1507998473', 'joomla|s:8988:"";', 413, 'admin'),
('r0746tiulhufm9017gsbs4rb33', 0, 0, '1508005071', 'joomla|s:4636:"";', 413, 'admin');

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_tags`
--

CREATE TABLE IF NOT EXISTS `vhabe_tags` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы `vhabe_tags`
--

INSERT INTO `vhabe_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 413, '2017-10-13 09:26:58', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_template_styles`
--

CREATE TABLE IF NOT EXISTS `vhabe_template_styles` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Дамп данных таблицы `vhabe_template_styles`
--

INSERT INTO `vhabe_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(4, 'beez3', 0, '0', 'Beez3 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.png","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(7, 'protostar', 0, '0', 'protostar - Default', '{"templateColor":"","logoFile":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}'),
(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}'),
(11, 'gk_storebox', 0, '1', 'gk_storebox - По умолчанию', '{"template_color":"1","default_layout":"default","layout_override":"","template_width":"1230","tablet_width":"1024","tablet_small_width":"820","mobile_width":"580","sidebar_position":"right","sidebar_width":"30","sidebar_width_for_pages":"","rwd":"1","font_name_group1":"standard;Arial, Helvetica, sans-serif","font_rules_group1":"","font_name_group2":"standard;Arial, Helvetica, sans-serif","font_rules_group2":"","font_name_group3":"standard;Arial, Helvetica, sans-serif","font_rules_group3":"","font_name_group4":"standard;Arial, Helvetica, sans-serif","font_rules_group4":"","logo_type":"image","logo_image":"","logo_text":"","logo_slogan":"","print_logo":"","print_behaviour":"nothing","favicon_image":"","touch_image":"","stylearea":"0","framework_logo":"0","copyrights":"","webmaster_contact_type":"email","webmaster_contact":"webmaster@gavick.com","typography":"0","typo_iconset":"0","google_analytics":"","tools":"all","tools_for_pages":"","mootools_for_pages":"","suffix_override":"","module_override":"","show_menu":"1","menu_name":"mainmenu-ru-ru","startlevel":"0","endlevel":"-1","menu_animation":"slide","menu_height":"1","menu_width":"1","menu_col_width":"200","menu_duration":"500","fb_api_id":"","fb_lang":"en_US","fb_login":"0","fb_like":"0","fb_like_send":"0","fb_like_layout":"standard","fb_like_show_faces":"true","fb_like_width":"500","fb_like_action":"like","fb_like_font":"arial","fb_like_colorscheme":"light","google_plus":"1","google_plus_count":"1","google_plus_size":"medium","google_plus_lang":"en-GB","google_plus_share":"1","google_plus_share_annotation":"vertical-bubble","google_plus_share_size":"20","tweet_btn":"0","tweet_btn_data_count":"vertical","tweet_btn_data_via":"","tweet_btn_data_lang":"en","pinterest_btn":"0","pinterest_btn_style":"horizontal","excluded_arts":"","cookie_consent":"0","consenttype":"explicit","cookie_latest_version":"0","cookie_use_ssl":"0","banner_position":"bottom","banner_tag_placement":"bottom-right","cookie_style":"light","refreshOnConsent":"0","cookiecss":"1","use_gk_cache":"0","css_cache":"0","css_compression":"0","css_override":"0","css_prefixer":"0","js_compression":"0","jscss_excluded":"","css_custom":""}');

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_ucm_base`
--

CREATE TABLE IF NOT EXISTS `vhabe_ucm_base` (
...
--
-- Структура таблицы `vhabe_ucm_content`
--

CREATE TABLE IF NOT EXISTS `vhabe_ucm_content` (
...
--
-- Структура таблицы `vhabe_ucm_history`
--

CREATE TABLE IF NOT EXISTS `vhabe_ucm_history` (
...
--
-- Дамп данных таблицы `vhabe_ucm_history`
--

INSERT INTO `vhabe_ucm_history` (`version_id`, `ucm_item_id`, `ucm_type_id`, `version_note`, `save_date`, `editor_user_id`, `character_count`, `sha1_hash`, `version_data`, `keep_forever`) VALUES
(1, 8, 5, '', '2017-10-13 09:29:27', 0, 560, 'b485438621741e427e7210509a4731ace33667c6', '{"id":8,"asset_id":60,"parent_id":"1","lft":"11","rgt":12,"level":1,"path":null,"extension":"com_content","title":"Category (en-gb)","alias":"category-en-gb","note":null,"description":"","published":1,"checked_out":null,"checked_out_time":null,"access":1,"params":"{\\"target\\":\\"\\",\\"image\\":\\"\\"}","metadesc":"","metakey":"","metadata":"{\\"page_title\\":\\"\\",\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":413,"created_time":"2017-10-13 09:29:27","modified_user_id":null,"modified_time":"2017-10-13 09:29:27","hits":null,"language":"en-GB","version":null}', 0),
(2, 1, 1, '', '2017-10-13 09:29:27', 0, 1178, '189b6cdc45e1b6a02c34c001f0e6e9def15ca739', '{"id":1,"asset_id":61,"title":"Article (en-gb)","alias":"article-en-gb","introtext":"<p>Lorem ipsum ad his scripta blandit partiendo, eum fastidii accumsan euripidis in, eum liber hendrerit an. Qui ut wisi vocibus suscipiantur, quo dicit ridens inciderint id. Quo mundi lobortis reformidans eu, legimus senseritdefiniebas an eos. Eu sit tincidunt incorrupte definitionem, vis mutat affert percipit cu, eirmod consectetuer signiferumque eu per. In usu latineequidem dolores. Quo no falli viris intellegam, ut fugit veritus placeratper. Ius id vidit volumus mandamus, vide veritus democritum te nec, ei eosdebet libris consulatu.<\\/p>","fulltext":"","state":1,"catid":8,"created":"2017-10-13 09:29:27","created_by":413,"created_by_alias":"Joomla","modified":"2017-10-13 09:29:27","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2017-10-13 09:29:27","publish_down":"0000-00-00 00:00:00","images":"[]","urls":"[]","attribs":"{}","version":1,"ordering":null,"metakey":"","metadesc":"","access":1,"hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\",\\"tags\\":null}","featured":1,"language":"en-GB","xreference":null}', 0),
(3, 9, 5, '', '2017-10-13 09:29:27', 0, 608, '263cff6831b9a04c4e34f900021dab2d1954de5c', '{"id":9,"asset_id":64,"parent_id":"1","lft":"13","rgt":14,"level":1,"path":null,"extension":"com_content","title":"\\u041a\\u0430\\u0442\\u0435\\u0433\\u043e\\u0440\\u0438\\u044f (ru-ru)","alias":"kategoriya-ru-ru","note":null,"description":"","published":1,"checked_out":null,"checked_out_time":null,"access":1,"params":"{\\"target\\":\\"\\",\\"image\\":\\"\\"}","metadesc":"","metakey":"","metadata":"{\\"page_title\\":\\"\\",\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":413,"created_time":"2017-10-13 09:29:27","modified_user_id":null,"modified_time":"2017-10-13 09:29:27","hits":null,"language":"ru-RU","version":null}', 0),
(4, 2, 1, '', '2017-10-13 09:29:27', 0, 1220, '00a225241977141982ba9a59a7f46bc4d112916c', '{"id":2,"asset_id":65,"title":"\\u041c\\u0430\\u0442\\u0435\\u0440\\u0438\\u0430\\u043b (ru-ru)","alias":"material-ru-ru","introtext":"<p>Lorem ipsum ad his scripta blandit partiendo, eum fastidii accumsan euripidis in, eum liber hendrerit an. Qui ut wisi vocibus suscipiantur, quo dicit ridens inciderint id. Quo mundi lobortis reformidans eu, legimus senseritdefiniebas an eos. Eu sit tincidunt incorrupte definitionem, vis mutat affert percipit cu, eirmod consectetuer signiferumque eu per. In usu latineequidem dolores. Quo no falli viris intellegam, ut fugit veritus placeratper. Ius id vidit volumus mandamus, vide veritus democritum te nec, ei eosdebet libris consulatu.<\\/p>","fulltext":"","state":1,"catid":9,"created":"2017-10-13 09:29:27","created_by":413,"created_by_alias":"Joomla","modified":"2017-10-13 09:29:27","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2017-10-13 09:29:27","publish_down":"0000-00-00 00:00:00","images":"[]","urls":"[]","attribs":"{}","version":1,"ordering":null,"metakey":"","metadesc":"","access":1,"hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\",\\"tags\\":null}","featured":1,"language":"ru-RU","xreference":null}', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_updates`
--

CREATE TABLE IF NOT EXISTS `vhabe_updates` (
...
--
-- Дамп данных таблицы `vhabe_updates`
--

INSERT INTO `vhabe_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
(1, 22, 0, 'VirtueMart - Shipment, by Weight, country, zip,... ', 'VirtueMart - Shipment, Shipment, by Weight, country, zip,... ', 'standard', 'plugin', 'vmshipment', 0, '3.2.1', '', 'http://virtuemart.net/releases/vm3/plg_vmshipment_weight_countries_update.xml', 'https://docs.virtuemart.net/tutorials/installation-migration-upgrade/226-update-single-plugin-delivered-by-aio.html', ''),
(2, 27, 0, 'VM Framework Loader during Plugin Updates', 'Makes sure the VirtueMart framework is loaded during automatic plugin updates using Joomla''s plugin updater.', 'vmLoaderPluginUpdate', 'plugin', 'system', 1, '3.2.3', '', 'http://virtuemart.net/releases/vm3/plg_system_vmLoaderPluginUpdate_update.xml', 'https://docs.virtuemart.net/tutorials/installation-migration-upgrade/226-update-single-plugin-delivered-by-aio.html', ''),
(3, 30, 0, 'VirtueMart Product module', 'VirtueMart Product module', 'mod_virtuemart_product', 'plugin', '', 0, '3.2.1', '', 'http://virtuemart.net/releases/vm3/mod_virtuemart_product_update.xml', 'https://docs.virtuemart.net/tutorials/installation-migration-upgrade/226-update-single-plugin-delivered-by-aio.html', '');

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_update_sites`
--

CREATE TABLE IF NOT EXISTS `vhabe_update_sites` (
...
--
-- Дамп данных таблицы `vhabe_update_sites`
--

INSERT INTO `vhabe_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1507997521, ''),
...
(4, 'JCE Editor Package', 'collection', 'https://cdn.joomlacontenteditor.net/updates/xml/pkg_jce.xml', 1, 1507997521, ''),
(5, 'VirtueMart3 Update Site', 'extension', 'http://virtuemart.net/releases/vm3/virtuemart_update.xml', 1, 1507997521, ''),
(6, 'VirtueMart plg_vmpayment_standard Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmpayment_standard_update.xml', 1, 1507997522, ''),
(7, 'VirtueMart plg_vmpayment_klarna Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmpayment_klarna_update.xml', 1, 1507997522, ''),
(8, 'VirtueMart plg_vmpayment_klarnacheckout Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmpayment_klarnacheckout_update.xml', 1, 1507997522, ''),
(9, 'VirtueMart plg_vmpayment_sofort Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmpayment_sofort_update.xml', 1, 1507997523, ''),
(10, 'VirtueMart plg_vmpayment_paypal Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmpayment_paypal_update.xml', 1, 1507997523, ''),
(11, 'VirtueMart plg_vmpayment_heidelpay Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmpayment_heidelpay_update.xml', 1, 1507997524, ''),
(12, 'VirtueMart plg_vmpayment_paybox Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmpayment_paybox_update.xml', 1, 1507997524, ''),
(13, 'VirtueMart3 plg_vmpayment_tco Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmpayment_tco_update.xml', 1, 1507997524, ''),
(14, 'VirtueMart plg_vmpayment_amazon Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmpayment_amazon_update.xml', 1, 1507997525, ''),
(15, 'VirtueMart plg_system_amazon Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_system_amazon_update.xml', 1, 1507997528, ''),
(16, 'VirtueMart plg_vmpayment_realex_hpp_api Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmpayment_realex_hpp_api_update.xml', 1, 1507997528, ''),
(17, 'VirtueMart plg_vmuserfield_realex_hpp_api Update Site', 'extension', '\n            http://virtuemart.net/releases/vm3/plg_vmuserfield_realex_hpp_api_update.xml', 1, 1507997529, ''),
(18, 'VirtueMart3 plg_vmpayment_skrill Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmpayment_skrill_update.xml', 1, 1507997529, ''),
(19, 'VirtueMart plg_vmpayment_authorizenet Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmpayment_authorisenet_update.xml', 1, 1507997530, ''),
(20, 'VirtueMart plg_vmpayment_sofort_ideal Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmpayment_sofort_ideal_update.xml', 1, 1507997530, ''),
(21, 'VirtueMart plg_vmpayment_klikandpay Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmpayment_klikandpay_update.xml', 1, 1507997530, ''),
(22, 'VirtueMart3 plg_vmshipment_weight_countries Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmshipment_weight_countries_update.xml', 1, 1507997531, ''),
(23, 'VirtueMart3 plg_vmcustom_textinput Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmcustom_textinput_update.xml', 1, 1507997531, ''),
(24, 'VirtueMart3 plg_vmcustom_specification Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmcustom_specification_update.xml', 1, 1507997531, ''),
(25, 'VirtueMart3 plg_vmcalculation_avalara Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_vmcalculation_avalara_update.xml', 1, 1507997532, ''),
(26, 'VirtueMart3 plg_search_virtuemart Update Site', 'extension', 'http://virtuemart.net/releases/vm3/plg_search_virtuemart_update.xml', 1, 1507997532, ''),
(27, 'VM Framework Loader during Plugin Updates', 'extension', 'http://virtuemart.net/releases/vm3/plg_system_vmLoaderPluginUpdate_update.xml', 1, 1507997532, ''),
(28, 'VirtueMart3 MOD_VMENU Update Site', 'extension', 'http://virtuemart.net/releases/vm3/mod_vmmenu_update.xml', 1, 1507997533, ''),
(29, 'VirtueMart3 mod_virtuemart_currencies Update Site', 'extension', 'http://virtuemart.net/releases/vm3/mod_virtuemart_currencies_update.xml', 1, 1507997533, ''),
(30, 'VirtueMart3 mod_virtuemart_product Update Site', 'extension', 'http://virtuemart.net/releases/vm3/mod_virtuemart_product_update.xml', 1, 1507997534, ''),
(31, 'VirtueMart3 mod_virtuemart_search Update Site', 'extension', 'http://virtuemart.net/releases/vm3/mod_virtuemart_search_update.xml', 1, 1507997534, ''),
(32, 'VirtueMart3 mod_virtuemart_manufacturer Update Site', 'extension', 'http://virtuemart.net/releases/vm3/mod_virtuemart_manufacturer_update.xml', 1, 1507997534, ''),
(33, 'VirtueMart3 mod_virtuemart_cart Update Site', 'extension', 'http://virtuemart.net/releases/vm3/mod_virtuemart_cart_update.xml', 1, 1507997535, ''),
(34, 'VirtueMart3 mod_virtuemart_category Update Site', 'extension', 'http://virtuemart.net/releases/vm3/mod_virtuemart_category_update.xml', 1, 1507997535, ''),
(35, 'VirtueMart3 AIO Update Site', 'extension', 'http://virtuemart.net/releases/vm3/virtuemart_aio_update.xml', 1, 1507997535, ''),
(36, 'TCPDF Update Site', 'extension', 'http://virtuemart.net/releases/TCPDF/tcpdf.xml', 1, 1507997536, '');

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `vhabe_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Дамп данных таблицы `vhabe_update_sites_extensions`
--

INSERT INTO `vhabe_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 802),
(2, 10002),
(3, 28),
...
--
-- Структура таблицы `vhabe_usergroups`
--

CREATE TABLE IF NOT EXISTS `vhabe_usergroups` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
...
--
-- Дамп данных таблицы `vhabe_usergroups`
--

INSERT INTO `vhabe_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Структура таблицы `vhabe_users`
--

CREATE TABLE IF NOT EXISTS `vhabe_users` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `vhabe_users`
--

INSERT INTO `vhabe_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(413, 'Super User', 'admin', 's211211@ukr.net', '$2y$10$Q2REBuU1kln9NjOMKDHhIeWqEHhJIiEnjVNCYGRfxK7I4DEVa911e', 0, 1, '2017-10-13 09:26:58', '2017-10-14 08:36:47', '0', '{}', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_user_keys`
--

CREATE TABLE IF NOT EXISTS `vhabe_user_keys` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_user_notes`
--

CREATE TABLE IF NOT EXISTS `vhabe_user_notes` (
  `id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `vhabe_user_profiles`
--

CREATE TABLE IF NOT EXISTS `vhabe_user_profiles` (
...
--
-- Структура таблицы `vhabe_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `vhabe_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `vhabe_user_usergroup_map`
--

INSERT INTO `vhabe_user_usergroup_map` (`user_id`, `group_id`) VALUES
(413, 8);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_utf8_conversion`
--

CREATE TABLE IF NOT EXISTS `vhabe_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `vhabe_utf8_conversion`
--

INSERT INTO `vhabe_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_viewlevels`
--

CREATE TABLE IF NOT EXISTS `vhabe_viewlevels` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Дамп данных таблицы `vhabe_viewlevels`
--

INSERT INTO `vhabe_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Структура таблицы `vhabe_virtuemart_adminmenuentries`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_adminmenuentries` (
...
--
-- Дамп данных таблицы `vhabe_virtuemart_adminmenuentries`
--

INSERT INTO `vhabe_virtuemart_adminmenuentries` (`id`, `module_id`, `parent_id`, `name`, `link`, `depends`, `icon_class`, `ordering`, `published`, `tooltip`, `view`, `task`) VALUES
...
--
-- Структура таблицы `vhabe_virtuemart_calcs`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_calcs` (
...
--
-- Дамп данных таблицы `vhabe_virtuemart_calcs`
--

INSERT INTO `vhabe_virtuemart_calcs` (`virtuemart_calc_id`, `virtuemart_vendor_id`, `calc_jplugin_id`, `calc_name`, `calc_descr`, `calc_kind`, `calc_value_mathop`, `calc_value`, `calc_currency`, `calc_shopper_published`, `calc_vendor_published`, `publish_up`, `publish_down`, `for_override`, `calc_params`, `ordering`, `shared`, `published`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES
(1, 1, 0, 'Сезонная скидка на тренажеры', 'Сезонная скидка на тренажеры -10% в течение октября', 'Tax', '-%', '10.0000', 131, 0, 0, '2017-10-01 00:00:00', '2017-10-31 00:00:00', 0, '', 1, 0, 1, '2017-10-14 08:30:55', 413, '2017-10-14 08:32:34', 413, '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_calc_categories`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_calc_categories` (
...
--
-- Дамп данных таблицы `vhabe_virtuemart_calc_categories`
--

INSERT INTO `vhabe_virtuemart_calc_categories` (`id`, `virtuemart_calc_id`, `virtuemart_category_id`) VALUES
(1, 1, 2);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_calc_countries`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_calc_countries` (
  `id` int(1) unsigned NOT NULL,
  `virtuemart_calc_id` int(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `vhabe_virtuemart_calc_manufacturers`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_calc_manufacturers` (
  `id` int(1) unsigned NOT NULL,
  `virtuemart_calc_id` int(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `vhabe_virtuemart_calc_shoppergroups`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_calc_shoppergroups` (
  `id` int(1) unsigned NOT NULL,
  `virtuemart_calc_id` int(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы `vhabe_virtuemart_calc_shoppergroups`
--

INSERT INTO `vhabe_virtuemart_calc_shoppergroups` (`id`, `virtuemart_calc_id`, `virtuemart_shoppergroup_id`) VALUES
(1, 1, 3);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_calc_states`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_calc_states` (
  `id` int(1) unsigned NOT NULL,
  `virtuemart_calc_id` int(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `vhabe_virtuemart_carts`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_carts` (
...
--
-- Дамп данных таблицы `vhabe_virtuemart_carts`
--

INSERT INTO `vhabe_virtuemart_carts` (`virtuemart_cart_id`, `virtuemart_user_id`, `virtuemart_vendor_id`, `cartData`, `created_on`, `created_by`, `modified_on`, `modified_by`) VALUES
(1, 413, 1, , '0000-00-00 00:00:00', 0, '2017-10-14 16:17:54', 413);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_categories`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_categories` (
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0'
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='Product Categories are stored here';

--
-- Дамп данных таблицы `vhabe_virtuemart_categories`
--

INSERT INTO `vhabe_virtuemart_categories` (`virtuemart_category_id`, `virtuemart_vendor_id`, `category_template`, `category_layout`, `category_product_layout`, `products_per_row`, `limit_list_step`, `limit_list_initial`, `hits`, `cat_params`, `metarobot`, `metaauthor`, `ordering`, `shared`, `published`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES
(1, 1, '', '', '', '', '0', 0, 0, 'show_store_desc=""|showcategory_desc=""|showcategory=""|categories_per_row=""|showproducts=""|omitLoaded=""|showsearch=""|productsublayout=""|featured=""|featured_rows=""|omitLoaded_featured=""|discontinued=""|discontinued_rows=""|omitLoaded_discontinued=""|latest=""|latest_rows=""|omitLoaded_latest=""|topten=""|topten_rows=""|omitLoaded_topten=""|recent=""|recent_rows=""|omitLoaded_recent=""|', '', '', 1, 0, 1, '2017-10-13 17:50:41', 413, '2017-10-13 17:51:02', 413, '0000-00-00 00:00:00', 0),
(2, 1, '', '', '', '', '0', 0, 0, 'show_store_desc=""|showcategory_desc=""|showcategory=""|categories_per_row=""|showproducts=""|omitLoaded=""|showsearch=""|productsublayout=""|featured=""|featured_rows=""|omitLoaded_featured=""|discontinued=""|discontinued_rows=""|omitLoaded_discontinued=""|latest=""|latest_rows=""|omitLoaded_latest=""|topten=""|topten_rows=""|omitLoaded_topten=""|recent=""|recent_rows=""|omitLoaded_recent=""|', '', '', 2, 0, 1, '2017-10-13 17:52:16', 413, '2017-10-13 17:52:24', 413, '0000-00-00 00:00:00', 0),
(3, 1, '', '', '', '', '0', 0, 0, 'show_store_desc=""|showcategory_desc=""|showcategory=""|categories_per_row=""|showproducts=""|omitLoaded=""|showsearch=""|productsublayout=""|featured=""|featured_rows=""|omitLoaded_featured=""|discontinued=""|discontinued_rows=""|omitLoaded_discontinued=""|latest=""|latest_rows=""|omitLoaded_latest=""|topten=""|topten_rows=""|omitLoaded_topten=""|recent=""|recent_rows=""|omitLoaded_recent=""|', '', '', 1, 0, 1, '2017-10-13 17:57:35', 413, '2017-10-13 17:57:35', 413, '0000-00-00 00:00:00', 0),
(4, 1, '', '', '', '', '0', 0, 0, 'show_store_desc=""|showcategory_desc=""|showcategory=""|categories_per_row=""|showproducts=""|omitLoaded=""|showsearch=""|productsublayout=""|featured=""|featured_rows=""|omitLoaded_featured=""|discontinued=""|discontinued_rows=""|omitLoaded_discontinued=""|latest=""|latest_rows=""|omitLoaded_latest=""|topten=""|topten_rows=""|omitLoaded_topten=""|recent=""|recent_rows=""|omitLoaded_recent=""|', '', '', 2, 0, 1, '2017-10-13 17:58:38', 413, '2017-10-13 18:01:43', 413, '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_categories_en_gb`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_categories_en_gb` (
  `virtuemart_category_id` int(1) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_virtuemart_categories_ru_ru`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_categories_ru_ru` (
  `virtuemart_category_id` int(1) unsigned NOT NULL,
  `category_name` varchar(180) NOT NULL DEFAULT '',
  `category_description` varchar(19000) NOT NULL DEFAULT '',
  `metadesc` varchar(400) NOT NULL DEFAULT '',
...
--
-- Дамп данных таблицы `vhabe_virtuemart_categories_ru_ru`
--

INSERT INTO `vhabe_virtuemart_categories_ru_ru` (`virtuemart_category_id`, `category_name`, `category_description`, `metadesc`, `metakey`, `customtitle`, `slug`) VALUES
(1, 'Спортивная одежда', '<p>Термокружка с поилкой- это настоящая находка для туризма или зимних путешествий. Можете представить, как особенно важно сохранить температуру напитка в холодный сезон. Такая кружка продумана как раз для таких целей. Она изготовлена из нержавеющей стали.</p>', '', '', '', 'спортивная-одежда'),
(2, 'Спортивные тренажеры', '<p>Брюки Захват специально разработаны для рыбалки, походов за грибами и активного отдыха. Брюки имеют камуфлированную расцветку, что делает человека малозаметным на фоне окружающего ландшафта. Состав ткани брюк: 50% хлопок и 50% полиэфир. Плотность материала 215 г/м2. Брюки имеют застёжку на пуговицы, широкий пояс с патами, с помощью чего можно регулировать объём по талии. Также у данной модели есть возможность регулировки объёма по низу изделия. И предусмотрены шлевки для широкого ремня.</p>', '', '', '', 'спортивные-тренажеры'),
(3, 'Спортивная форма', '<p>Спортивная формаСпортивная формаСпортивная формаСпортивная формаСпортивная формаСпортивная формаСпортивная формаСпортивная формаСпортивная форма</p>', '', '', '', 'спортивная-форма'),
(4, 'Кроссовки', '<p>описание КроссовкиКроссовкиКроссовкиКроссовкиКроссовкиКроссовкиКроссовкиКроссовки</p>', '', '', '', 'кроссовки');

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_category_categories`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_category_categories` (
  `id` int(1) unsigned NOT NULL,
  `category_parent_id` int(1) unsigned NOT NULL DEFAULT '0',
  `category_child_id` int(1) unsigned NOT NULL DEFAULT '0',
  `ordering` int(1) NOT NULL DEFAULT '0'
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='Category child-parent relation list';

--
-- Дамп данных таблицы `vhabe_virtuemart_category_categories`
--

INSERT INTO `vhabe_virtuemart_category_categories` (`id`, `category_parent_id`, `category_child_id`, `ordering`) VALUES
(1, 0, 1, 0),
(2, 0, 2, 0),
(3, 1, 3, 0),
(4, 1, 4, 0);
...
--
-- Структура таблицы `vhabe_virtuemart_category_medias`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_category_medias` (
  `id` int(1) unsigned NOT NULL,
  `virtuemart_category_id` int(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы `vhabe_virtuemart_category_medias`
--

INSERT INTO `vhabe_virtuemart_category_medias` (`id`, `virtuemart_category_id`, `virtuemart_media_id`, `ordering`) VALUES
(1, 1, 6, 1),
(2, 2, 7, 1),
(3, 3, 8, 1),
(5, 4, 10, 1);
...
--
-- Структура таблицы `vhabe_virtuemart_configs`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_configs` (
...
--
-- Дамп данных таблицы `vhabe_virtuemart_countries`
--

INSERT INTO `vhabe_virtuemart_countries` (`virtuemart_country_id`, `virtuemart_worldzone_id`, `country_name`, `country_3_code`, `country_2_code`, `ordering`, `published`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES
...
--
-- Структура таблицы `vhabe_virtuemart_coupons`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_coupons` (
...
--
-- Структура таблицы `vhabe_virtuemart_currencies`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_currencies` (
...
--
-- Дамп данных таблицы `vhabe_virtuemart_currencies`
--

INSERT INTO `vhabe_virtuemart_currencies` (`virtuemart_currency_id`, `virtuemart_vendor_id`, `currency_name`, `currency_code_2`, `currency_code_3`, `currency_numeric_code`, `currency_exchange_rate`, `currency_symbol`, `currency_decimal_place`, `currency_decimal_symbol`, `currency_thousands`, `currency_positive_style`, `currency_negative_style`, `ordering`, `shared`, `published`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES
...
(147, 1, 'Vietnamese Dong', '', 'VND', 704, '0.00000', '₫', '0', '', '', '{number} {symbol}', '{sign}{number} {symbol}', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
...
--
-- Структура таблицы `vhabe_virtuemart_customs`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_customs` (
...
--
-- Дамп данных таблицы `vhabe_virtuemart_customs`
--

INSERT INTO `vhabe_virtuemart_customs` (`virtuemart_custom_id`, `custom_parent_id`, `virtuemart_vendor_id`, `custom_jplugin_id`, `custom_element`, `admin_only`, `custom_title`, `show_title`, `custom_tip`, `custom_value`, `custom_desc`, `field_type`, `is_list`, `is_hidden`, `is_cart_attribute`, `is_input`, `searchable`, `layout_pos`, `custom_params`, `shared`, `published`, `created_on`, `created_by`, `ordering`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES
...
--
-- Структура таблицы `vhabe_virtuemart_invoices`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_invoices` (
...
--
-- Структура таблицы `vhabe_virtuemart_manufacturercategories`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_manufacturercategories` (
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0'
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Manufacturers are assigned to these categories';

--
-- Дамп данных таблицы `vhabe_virtuemart_manufacturercategories`
--

INSERT INTO `vhabe_virtuemart_manufacturercategories` (`virtuemart_manufacturercategories_id`, `published`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES
(1, 1, '2017-10-13 17:18:20', 413, '2017-10-13 17:18:20', 413, '0000-00-00 00:00:00', 0),
(2, 1, '2017-10-13 17:18:50', 413, '2017-10-13 17:18:50', 413, '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_manufacturercategories_en_gb`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_manufacturercategories_en_gb` (
  `virtuemart_manufacturercategories_id` int(1) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_virtuemart_manufacturercategories_ru_ru`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_manufacturercategories_ru_ru` (
  `virtuemart_manufacturercategories_id` int(1) unsigned NOT NULL,
  `mf_category_name` varchar(180) NOT NULL DEFAULT '',
  `mf_category_desc` varchar(19000) NOT NULL DEFAULT '',
  `slug` varchar(192) NOT NULL DEFAULT ''
...
--
-- Дамп данных таблицы `vhabe_virtuemart_manufacturercategories_ru_ru`
--

INSERT INTO `vhabe_virtuemart_manufacturercategories_ru_ru` (`virtuemart_manufacturercategories_id`, `mf_category_name`, `mf_category_desc`, `slug`) VALUES
(1, 'Производители спортивной одежды', 'Неспроста свинцовый сосуд мгновенно открывает квазиупругую колбу. Карусель быстра и кратковременна. Часто бывает, что ядерная лапка груба и продуманна.', 'производители-спортивной-одежды'),
(2, 'Производители спортивных тренажеров', 'Очевидно, феноменальная шестерня брезентового комплекта бережно увеличивает тайную лампу. Изящное значение резко и метастабильно. Платиновая инерция перегоревшего изолятора образовывает разделение.', 'производители-спортивных-тренажеров');

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_manufacturers`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_manufacturers` (
...
--
-- Дамп данных таблицы `vhabe_virtuemart_manufacturers`
--

INSERT INTO `vhabe_virtuemart_manufacturers` (`virtuemart_manufacturer_id`, `virtuemart_manufacturercategories_id`, `metarobot`, `metaauthor`, `hits`, `published`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES
(1, 1, '', '', 0, 1, '2017-10-13 17:21:23', 413, '2017-10-13 17:21:51', 413, '0000-00-00 00:00:00', 0),
(2, 1, '', '', 0, 1, '2017-10-13 17:23:07', 413, '2017-10-13 17:26:44', 413, '0000-00-00 00:00:00', 0),
(3, 2, '', '', 0, 1, '2017-10-13 17:26:29', 413, '2017-10-13 17:26:29', 413, '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_manufacturers_en_gb`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_manufacturers_en_gb` (
  `virtuemart_manufacturer_id` int(1) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_virtuemart_manufacturers_ru_ru`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_manufacturers_ru_ru` (
  `virtuemart_manufacturer_id` int(1) unsigned NOT NULL,
  `mf_name` varchar(180) NOT NULL DEFAULT '',
  `mf_email` varchar(255) NOT NULL DEFAULT '',
  `mf_desc` varchar(19000) NOT NULL DEFAULT '',
...
--
-- Дамп данных таблицы `vhabe_virtuemart_manufacturers_ru_ru`
--

INSERT INTO `vhabe_virtuemart_manufacturers_ru_ru` (`virtuemart_manufacturer_id`, `mf_name`, `mf_email`, `mf_desc`, `mf_url`, `metadesc`, `metakey`, `customtitle`, `slug`) VALUES
(1, 'Абибас', '', '<p>По всей видимости, недокуренный виски расширяет рыцаря. </p>', 'www.abibas.ru', '', '', '', 'абибас'),
(2, 'Nike', '', '<h3>Угольный дельтапланерист саркастичен</h3>', '', '', '', '', 'nike'),
(3, 'Ketler', '', '<p>asdfasdfasdfasdf</p>', '', '', '', '', 'ketler');

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_manufacturer_medias`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_manufacturer_medias` (
  `id` int(1) unsigned NOT NULL,
  `virtuemart_manufacturer_id` int(1) unsigned NOT NULL DEFAULT '0',
  `virtuemart_media_id` int(1) unsigned NOT NULL DEFAULT '0',
  `ordering` int(1) NOT NULL DEFAULT '0'
...
--
-- Дамп данных таблицы `vhabe_virtuemart_manufacturer_medias`
--

INSERT INTO `vhabe_virtuemart_manufacturer_medias` (`id`, `virtuemart_manufacturer_id`, `virtuemart_media_id`, `ordering`) VALUES
(3, 2, 4, 1),
(2, 1, 3, 1),
(4, 3, 5, 1);
...
--
-- Структура таблицы `vhabe_virtuemart_medias`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_medias` (
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0'
) ENGINE=MyISAM AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='Additional Images and Files which are assigned to products';

--
-- Дамп данных таблицы `vhabe_virtuemart_medias`
--

INSERT INTO `vhabe_virtuemart_medias` (`virtuemart_media_id`, `virtuemart_vendor_id`, `file_title`, `file_description`, `file_meta`, `file_class`, `file_mimetype`, `file_type`, `file_url`, `file_url_thumb`, `file_is_product_image`, `file_is_downloadable`, `file_is_forSale`, `file_params`, `file_lang`, `shared`, `published`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES
(1, 1, 'avatar_yoda.png', '', '', '', 'image/png', 'vendor', 'images/virtuemart/vendor/avatar_yoda.png', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 12:02:38', 413, '2017-10-14 08:36:41', 413, '0000-00-00 00:00:00', 0),
(2, 1, 'расписание2.jpg', '', '', '', 'image/jpeg', 'manufacturer', 'images/virtuemart/manufacturer/расписание2.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 17:21:23', 413, '2017-10-13 17:21:23', 413, '0000-00-00 00:00:00', 0),
(3, 1, 'расписание2.jpg_manufacturer', '', '', '', 'image/jpeg', 'manufacturer', 'images/virtuemart/manufacturer/IMG_0650.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 17:21:51', 413, '2017-10-13 17:21:51', 413, '0000-00-00 00:00:00', 0),
(4, 1, 'IMG_0510.jpg', '', '', '', 'image/jpeg', 'manufacturer', 'images/virtuemart/manufacturer/IMG_0510.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 17:23:07', 413, '2017-10-13 17:26:44', 413, '0000-00-00 00:00:00', 0),
(5, 1, 'IMG_0484.jpg', '', '', '', 'image/jpeg', 'manufacturer', 'images/virtuemart/manufacturer/IMG_0484.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 17:26:29', 413, '2017-10-13 17:26:29', 413, '0000-00-00 00:00:00', 0),
(6, 1, '11.jpg', '', '', '', 'image/jpeg', 'category', 'images/virtuemart/category/11.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 17:50:41', 413, '2017-10-13 17:51:02', 413, '0000-00-00 00:00:00', 0),
(7, 1, 'AGR-3LT.jpg', '', '', '', 'image/jpeg', 'category', 'images/virtuemart/category/AGR-3LT.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 17:52:16', 413, '2017-10-13 17:52:24', 413, '0000-00-00 00:00:00', 0),
(8, 1, '1-.800x600.jpg', '', '', '', 'image/jpeg', 'category', 'images/virtuemart/category/1-.800x600.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 17:57:35', 413, '2017-10-13 17:57:35', 413, '0000-00-00 00:00:00', 0),
(9, 1, 'Муза-3.jpg', '', '', '', 'image/jpeg', 'category', 'images/virtuemart/category/Муза-3.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 17:58:38', 413, '2017-10-13 17:58:38', 413, '0000-00-00 00:00:00', 0),
(10, 1, 'Муза-3.jpg_category', '', '', '', 'image/jpeg', 'category', 'images/virtuemart/category/9070.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 17:59:30', 413, '2017-10-13 18:01:43', 413, '0000-00-00 00:00:00', 0),
(11, 1, '3x3panel55-na-oporah2.jpg', '', '', '', 'image/jpeg', 'product', 'images/virtuemart/product/3x3panel55-na-oporah2.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 19:08:02', 413, '2017-10-13 19:13:10', 413, '0000-00-00 00:00:00', 0),
(12, 1, '3x3panel55-na-oporah2.jpg_product', '', '', '', 'image/jpeg', 'product', 'images/virtuemart/product/0000033_0.jpeg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 19:08:17', 413, '2017-10-13 19:08:17', 413, '0000-00-00 00:00:00', 0),
(13, 1, '3x3panel55-na-oporah2.jpg_product', '', '', '', 'image/jpeg', 'product', 'images/virtuemart/product/00316-8.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 19:09:26', 413, '2017-10-13 19:09:26', 413, '0000-00-00 00:00:00', 0),
(14, 1, '3x3panel55-na-oporah2.jpg_product', '', '', '', 'image/jpeg', 'product', 'images/virtuemart/product/antall_a-01.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 19:14:57', 413, '2017-10-13 19:14:57', 413, '0000-00-00 00:00:00', 0),
(15, 1, '3x3panel55-na-oporah2.jpg_product_product_product_product', '', '', '', 'image/jpeg', 'product', 'images/virtuemart/product/antall_almeon-04.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 19:15:47', 413, '2017-10-13 19:15:47', 413, '0000-00-00 00:00:00', 0),
(16, 1, '3x3panel55-na-oporah2.jpg_product_product_product_product_product', '', '', '', 'image/jpeg', 'product', 'images/virtuemart/product/1.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 19:25:47', 413, '2017-10-13 19:25:47', 413, '0000-00-00 00:00:00', 0),
(17, 1, '3x3panel55-na-oporah2.jpg_product_product_product_product_product_product', '', '', '', 'image/jpeg', 'product', 'images/virtuemart/product/2.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 19:27:12', 413, '2017-10-13 19:27:12', 413, '0000-00-00 00:00:00', 0),
(18, 1, '3x3panel55-na-oporah2.jpg_product_product_product_product_product_product_product', '', '', '', 'image/jpeg', 'product', 'images/virtuemart/product/main.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 19:29:06', 413, '2017-10-13 19:29:06', 413, '0000-00-00 00:00:00', 0),
(19, 1, '3x3panel55-na-oporah2.jpg_product_product_product_product_product_product_product_product', '', '', '', 'image/jpeg', 'product', 'images/virtuemart/product/11.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 19:30:06', 413, '2017-10-13 19:30:06', 413, '0000-00-00 00:00:00', 0),
(20, 1, '3x3panel55-na-oporah2.jpg_product_product_product_product_product_product_product_product_product', '', '', '', 'image/jpeg', 'product', 'images/virtuemart/product/27.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 19:30:14', 413, '2017-10-13 19:30:14', 413, '0000-00-00 00:00:00', 0),
(21, 1, '3x3panel55-na-oporah2.jpg_product_product_product_product_product_product_product_product_product_product', '', '', '', 'image/jpeg', 'product', 'images/virtuemart/product/main5.jpg', '', 0, 0, 0, '', '', 0, 1, '2017-10-13 19:30:59', 413, '2017-10-13 19:31:04', 413, '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_migration_oldtonew_ids`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_migration_oldtonew_ids` (
...
--
-- Структура таблицы `vhabe_virtuemart_modules`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_modules` (
...
--
-- Дамп данных таблицы `vhabe_virtuemart_modules`
--

INSERT INTO `vhabe_virtuemart_modules` (`module_id`, `module_name`, `module_description`, `module_perms`, `published`, `is_admin`, `ordering`) VALUES
...
--
-- Структура таблицы `vhabe_virtuemart_orders`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_orders` (
...
--
-- Структура таблицы `vhabe_virtuemart_orderstates`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_orderstates` (
...
--
-- Дамп данных таблицы `vhabe_virtuemart_orderstates`
--

INSERT INTO `vhabe_virtuemart_orderstates` (`virtuemart_orderstate_id`, `virtuemart_vendor_id`, `order_status_code`, `order_status_name`, `order_status_color`, `order_status_description`, `order_stock_handle`, `ordering`, `published`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES
...
--
-- Структура таблицы `vhabe_virtuemart_order_calc_rules`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_order_calc_rules` (
...
--
-- Структура таблицы `vhabe_virtuemart_order_histories`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_order_histories` (
...
--
-- Структура таблицы `vhabe_virtuemart_order_items`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_order_items` (
...
--
-- Структура таблицы `vhabe_virtuemart_order_userinfos`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_order_userinfos` (
...
--
-- Структура таблицы `vhabe_virtuemart_paymentmethods`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_paymentmethods` (
...
--
-- Структура таблицы `vhabe_virtuemart_paymentmethods_en_gb`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_paymentmethods_en_gb` (
  `virtuemart_paymentmethod_id` int(1) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_virtuemart_paymentmethods_ru_ru`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_paymentmethods_ru_ru` (
  `virtuemart_paymentmethod_id` int(1) unsigned NOT NULL,
  `payment_name` varchar(180) NOT NULL DEFAULT '',
  `payment_desc` varchar(19000) NOT NULL DEFAULT '',
  `slug` varchar(192) NOT NULL DEFAULT ''
...
--
-- Структура таблицы `vhabe_virtuemart_paymentmethod_shoppergroups`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_paymentmethod_shoppergroups` (
  `id` int(1) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_virtuemart_products`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_products` (
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0'
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='All products are stored here.';

--
-- Дамп данных таблицы `vhabe_virtuemart_products`
--

INSERT INTO `vhabe_virtuemart_products` (`virtuemart_product_id`, `virtuemart_vendor_id`, `product_parent_id`, `product_sku`, `product_gtin`, `product_mpn`, `product_weight`, `product_weight_uom`, `product_length`, `product_width`, `product_height`, `product_lwh_uom`, `product_url`, `product_in_stock`, `product_ordered`, `product_stockhandle`, `low_stock_notification`, `product_available_date`, `product_availability`, `product_special`, `product_discontinued`, `product_sales`, `product_unit`, `product_packaging`, `product_params`, `hits`, `intnotes`, `metarobot`, `metaauthor`, `layout`, `published`, `pordering`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES
(1, 1, 0, '00001', '', '', '2.0000', 'KG', '40.0000', '20.0000', '18.0000', 'CM', '', 10, 0, '0', 2, '2017-10-13 00:00:00', '', 0, 0, 0, 'KG', '0.1000', 'min_order_level=""|max_order_level=""|step_order_level=""|product_box="1"|', NULL, '', '', '', '', 1, 0, '2017-10-13 19:08:02', 413, '2017-10-13 19:13:10', 413, '0000-00-00 00:00:00', 0),
(2, 1, 0, '00002', '', '', '2.0000', 'KG', '40.0000', '20.0000', '18.0000', 'CM', '', 3, 0, '0', 2, '2017-10-13 00:00:00', '', 0, 0, 0, 'KG', '0.1000', 'min_order_level=""|max_order_level=""|step_order_level=""|product_box="1"|', NULL, '', '', '', '', 1, 0, '2017-10-13 19:13:16', 413, '2017-10-13 19:14:57', 413, '0000-00-00 00:00:00', 0),
(3, 1, 0, '00003', '', '', '2.0000', 'KG', '40.0000', '20.0000', '18.0000', 'CM', '', 5, 0, '0', 2, '2017-10-13 00:00:00', '', 0, 0, 0, 'KG', '0.1000', 'min_order_level=""|max_order_level=""|step_order_level=""|product_box="1"|', NULL, '', '', '', '', 1, 0, '2017-10-13 19:15:05', 413, '2017-10-13 19:15:47', 413, '0000-00-00 00:00:00', 0),
(4, 1, 0, '00006', '', '', '2.0000', 'KG', '40.0000', '20.0000', '18.0000', 'CM', '', 5, 0, '0', 2, '2017-10-13 00:00:00', '', 0, 0, 0, 'KG', '0.1000', 'min_order_level=""|max_order_level=""|step_order_level=""|product_box="1"|', NULL, '', '', '', '', 1, 0, '2017-10-13 19:24:32', 413, '2017-10-13 19:25:47', 413, '0000-00-00 00:00:00', 0),
(5, 1, 0, '00006', '', '', '2.0000', 'KG', '40.0000', '20.0000', '18.0000', 'CM', '', 5, 0, '0', 2, '2017-10-13 00:00:00', '', 0, 0, 0, 'KG', '0.1000', 'min_order_level=""|max_order_level=""|step_order_level=""|product_box="1"|', NULL, '', '', '', '', 1, 0, '2017-10-13 19:26:41', 413, '2017-10-13 19:27:12', 413, '0000-00-00 00:00:00', 0),
(6, 1, 0, '000088-t', '', '', '60.0000', 'KG', '2.0000', '2.0000', '2.0000', 'M', '', 1, 0, '0', 0, '2017-10-13 00:00:00', '', 0, 0, 0, 'KG', '1.0000', 'min_order_level=""|max_order_level=""|step_order_level=""|product_box="1"|', NULL, '', '', '', '', 1, 0, '2017-10-13 19:27:17', 413, '2017-10-13 19:29:06', 413, '0000-00-00 00:00:00', 0),
(7, 1, 0, '00234-t', '', '', '60.0000', 'KG', '2.0000', '2.0000', '2.0000', 'M', '', 1, 0, '0', 0, '2017-10-13 00:00:00', '', 0, 0, 0, 'KG', '1.0000', 'min_order_level=""|max_order_level=""|step_order_level=""|product_box="1"|', NULL, '', '', '', '', 1, 0, '2017-10-13 19:29:28', 413, '2017-10-13 19:30:14', 413, '0000-00-00 00:00:00', 0),
(8, 1, 0, '00234-t', '', '', '60.0000', 'KG', '2.0000', '2.0000', '2.0000', 'M', '', 1, 0, '0', 0, '2017-10-13 00:00:00', '', 0, 0, 0, 'KG', '1.0000', 'min_order_level=""|max_order_level=""|step_order_level=""|product_box="1"|', NULL, '', '', '', '', 1, 0, '2017-10-13 19:30:24', 413, '2017-10-13 19:31:04', 413, '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_products_en_gb`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_products_en_gb` (
  `virtuemart_product_id` int(1) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_virtuemart_products_ru_ru`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_products_ru_ru` (
  `virtuemart_product_id` int(1) unsigned NOT NULL,
  `product_s_desc` varchar(2000) NOT NULL DEFAULT '',
  `product_desc` varchar(18400) NOT NULL DEFAULT '',
  `product_name` varchar(180) NOT NULL DEFAULT '',
...
--
-- Дамп данных таблицы `vhabe_virtuemart_products_ru_ru`
--

INSERT INTO `vhabe_virtuemart_products_ru_ru` (`virtuemart_product_id`, `product_s_desc`, `product_desc`, `product_name`, `metadesc`, `metakey`, `customtitle`, `slug`) VALUES
(1, 'Теплые и комфортные сапоги для зимней рыбалки и охоты. Внутренний вкладыш хорошо защищает от проникновения холодного воздуха вовнутрь обуви и предотвращает нежелательный тепловой обмен с окружающей средой.', '<p>Теплые и комфортные сапоги для зимней рыбалки и охоты. Внутренний вкладыш хорошо защищает от проникновения холодного воздуха вовнутрь обуви и предотвращает нежелательный тепловой обмен с окружающей средой. Специальные утяжки позволяют надежно зафиксировать сапоги на ноге для удобной длительной ходьбы. Выполнены из морозоустойчивого материала, который не теряет своей эластичности под воздействием минусовых температур, отлично гнется и не трескается. </p>', 'Кроссовки Adidas DF32', '', '', '', 'кроссовки-adidas-df32'),
(2, 'Теплые и комфортные сапоги для зимней рыбалки и охоты. Внутренний вкладыш хорошо защищает от проникновения холодного воздуха вовнутрь обуви и предотвращает нежелательный тепловой обмен с окружающей средой.', '<p>Теплые и комфортные сапоги для зимней рыбалки и охоты. Внутренний вкладыш хорошо защищает от проникновения холодного воздуха вовнутрь обуви и предотвращает нежелательный тепловой обмен с окружающей средой. Специальные утяжки позволяют надежно зафиксировать сапоги на ноге для удобной длительной ходьбы. Выполнены из морозоустойчивого материала, который не теряет своей эластичности под воздействием минусовых температур, отлично гнется и не трескается. </p>', 'Кроссовки Adidas DF34', '', '', '', 'кроссовки-adidas-df34'),
(3, 'Теплые и комфортные сапоги для зимней рыбалки и охоты. Внутренний вкладыш хорошо защищает от проникновения холодного воздуха вовнутрь обуви и предотвращает нежелательный тепловой обмен с окружающей средой.', '<p>Теплые и комфортные сапоги для зимней рыбалки и охоты. Внутренний вкладыш хорошо защищает от проникновения холодного воздуха вовнутрь обуви и предотвращает нежелательный тепловой обмен с окружающей средой. Специальные утяжки позволяют надежно зафиксировать сапоги на ноге для удобной длительной ходьбы. Выполнены из морозоустойчивого материала, который не теряет своей эластичности под воздействием минусовых температур, отлично гнется и не трескается. </p>', 'Кроссовки Adidas DF35', '', '', '', 'кроссовки-adidas-df35'),
(4, 'Теплые и комфортные сапоги для зимней рыбалки и охоты. Внутренний вкладыш хорошо защищает от проникновения холодного воздуха вовнутрь обуви и предотвращает нежелательный тепловой обмен с окружающей средой.', '<p>Теплые и комфортные сапоги для зимней рыбалки и охоты. Внутренний вкладыш хорошо защищает от проникновения холодного воздуха вовнутрь обуви и предотвращает нежелательный тепловой обмен с окружающей средой. Специальные утяжки позволяют надежно зафиксировать сапоги на ноге для удобной длительной ходьбы. Выполнены из морозоустойчивого материала, который не теряет своей эластичности под воздействием минусовых температур, отлично гнется и не трескается. </p>', 'Кроссовки Nike Nls-88', '', '', '', 'кроссовки-nike-nls-88'),
(5, 'Теплые и комфортные сапоги для зимней рыбалки и охоты. Внутренний вкладыш хорошо защищает от проникновения холодного воздуха вовнутрь обуви и предотвращает нежелательный тепловой обмен с окружающей средой.', '<p>Теплые и комфортные сапоги для зимней рыбалки и охоты. Внутренний вкладыш хорошо защищает от проникновения холодного воздуха вовнутрь обуви и предотвращает нежелательный тепловой обмен с окружающей средой. Специальные утяжки позволяют надежно зафиксировать сапоги на ноге для удобной длительной ходьбы. Выполнены из морозоустойчивого материала, который не теряет своей эластичности под воздействием минусовых температур, отлично гнется и не трескается. </p>', 'Кроссовки Nike Nls-89', '', '', '', 'кроссовки-nike-nls-89'),
(6, 'Очень удобные сапоги дл рыбалки и охоты. Модель идеально подходит для тех, кто привык преодолевать большие расстояния.', '<p>Очень удобные сапоги дл рыбалки и охоты. Модель идеально подходит для тех, кто привык преодолевать большие расстояния. Рисунок подошвы специально разработан таким образом, чтобы снизить скольжение по льду. Шнуровка спереди сапог способствует удобной посадке обуви на ноге, а полипропиленовый носок эффективно отводит влагу и сохраняет ноги в тепле. Сапоги изготовлены из морозоустойчивого материала, который не теряет своей эластичности при минусовых температурах. </p>', 'Тренажер Ketler', '', '', '', 'тренажер-ketler'),
(7, 'Очень удобные сапоги дл рыбалки и охоты. Модель идеально подходит для тех, кто привык преодолевать большие расстояния.', '<p>Очень удобные сапоги дл рыбалки и охоты. Модель идеально подходит для тех, кто привык преодолевать большие расстояния. Рисунок подошвы специально разработан таким образом, чтобы снизить скольжение по льду. Шнуровка спереди сапог способствует удобной посадке обуви на ноге, а полипропиленовый носок эффективно отводит влагу и сохраняет ноги в тепле. Сапоги изготовлены из морозоустойчивого материала, который не теряет своей эластичности при минусовых температурах. </p>', 'Тренажер Ketler ty-22', '', '', '', 'тренажер-ketler-ty-22'),
(8, 'Очень удобные сапоги дл рыбалки и охоты. Модель идеально подходит для тех, кто привык преодолевать большие расстояния.', '<p>Очень удобные сапоги дл рыбалки и охоты. Модель идеально подходит для тех, кто привык преодолевать большие расстояния. Рисунок подошвы специально разработан таким образом, чтобы снизить скольжение по льду. Шнуровка спереди сапог способствует удобной посадке обуви на ноге, а полипропиленовый носок эффективно отводит влагу и сохраняет ноги в тепле. Сапоги изготовлены из морозоустойчивого материала, который не теряет своей эластичности при минусовых температурах. </p>', 'Тренажер Ketler ty-23', '', '', '', 'тренажер-ketler-ty-23');

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_product_categories`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_product_categories` (
  `id` int(1) unsigned NOT NULL,
  `virtuemart_product_id` int(1) unsigned NOT NULL DEFAULT '0',
  `virtuemart_category_id` int(1) unsigned NOT NULL DEFAULT '0',
  `ordering` int(1) NOT NULL DEFAULT '0'
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='Maps Products to Categories';

--
-- Дамп данных таблицы `vhabe_virtuemart_product_categories`
--

INSERT INTO `vhabe_virtuemart_product_categories` (`id`, `virtuemart_product_id`, `virtuemart_category_id`, `ordering`) VALUES
(1, 1, 4, 0),
(2, 2, 4, 0),
(3, 3, 4, 0),
(4, 4, 4, 0),
...
--
-- Структура таблицы `vhabe_virtuemart_product_customfields`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_product_customfields` (
...
--
-- Структура таблицы `vhabe_virtuemart_product_manufacturers`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_product_manufacturers` (
  `id` int(1) unsigned NOT NULL,
  `virtuemart_product_id` int(1) DEFAULT NULL,
  `virtuemart_manufacturer_id` int(1) unsigned DEFAULT NULL
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='Maps a product to a manufacturer';

--
-- Дамп данных таблицы `vhabe_virtuemart_product_manufacturers`
--

INSERT INTO `vhabe_virtuemart_product_manufacturers` (`id`, `virtuemart_product_id`, `virtuemart_manufacturer_id`) VALUES
(1, 1, 1),
(2, 2, 1),
(3, 3, 1),
(6, 5, 2),
...
--
-- Структура таблицы `vhabe_virtuemart_product_medias`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_product_medias` (
  `id` int(1) unsigned NOT NULL,
  `virtuemart_product_id` int(1) unsigned NOT NULL DEFAULT '0',
  `virtuemart_media_id` int(1) unsigned NOT NULL DEFAULT '0',
  `ordering` int(1) NOT NULL DEFAULT '0'
...
--
-- Дамп данных таблицы `vhabe_virtuemart_product_medias`
--

INSERT INTO `vhabe_virtuemart_product_medias` (`id`, `virtuemart_product_id`, `virtuemart_media_id`, `ordering`) VALUES
(1, 1, 11, 1),
(8, 3, 15, 1),
(3, 1, 13, 2),
(17, 7, 20, 2),
...
--
-- Структура таблицы `vhabe_virtuemart_product_prices`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_product_prices` (
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0'
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='Holds price records for a product';

--
-- Дамп данных таблицы `vhabe_virtuemart_product_prices`
--

INSERT INTO `vhabe_virtuemart_product_prices` (`virtuemart_product_price_id`, `virtuemart_product_id`, `virtuemart_shoppergroup_id`, `product_price`, `override`, `product_override_price`, `product_tax_id`, `product_discount_id`, `product_currency`, `product_price_publish_up`, `product_price_publish_down`, `price_quantity_start`, `price_quantity_end`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES
(1, 1, 0, '3600.000000', 0, '0.00000', 0, 0, 131, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 0, '2017-10-13 19:08:02', 413, '2017-10-13 19:13:10', 413, '0000-00-00 00:00:00', 0),
(2, 2, 0, '3800.000000', 0, '0.00000', 0, 0, 131, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 0, '2017-10-13 19:13:16', 413, '2017-10-13 19:14:57', 413, '0000-00-00 00:00:00', 0),
(3, 3, 0, '3200.000000', 0, '0.00000', 0, 0, 131, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 0, '2017-10-13 19:15:05', 413, '2017-10-13 19:15:47', 413, '0000-00-00 00:00:00', 0),
(4, 4, 0, '3500.000000', 0, '0.00000', 0, 0, 131, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 0, '2017-10-13 19:24:32', 413, '2017-10-13 19:25:47', 413, '0000-00-00 00:00:00', 0),
(5, 5, 0, '1500.000000', 0, '0.00000', 0, 0, 131, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 0, '2017-10-13 19:26:41', 413, '2017-10-13 19:27:12', 413, '0000-00-00 00:00:00', 0),
(6, 6, 0, '25700.000000', 0, '0.00000', 0, 0, 131, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 0, '2017-10-13 19:27:17', 413, '2017-10-13 19:29:06', 413, '0000-00-00 00:00:00', 0),
(7, 7, 0, '33700.000000', 0, '0.00000', 0, 0, 131, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 0, '2017-10-13 19:29:28', 413, '2017-10-13 19:30:14', 413, '0000-00-00 00:00:00', 0),
(8, 8, 0, '45800.000000', 0, '0.00000', 0, 0, 131, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 0, '2017-10-13 19:30:24', 413, '2017-10-13 19:31:04', 413, '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_product_shoppergroups`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_product_shoppergroups` (
  `id` int(1) unsigned NOT NULL,
  `virtuemart_product_id` int(1) unsigned NOT NULL DEFAULT '0',
  `virtuemart_shoppergroup_id` int(1) unsigned NOT NULL DEFAULT '0'
...
--
-- Структура таблицы `vhabe_virtuemart_ratings`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_ratings` (
...
--
-- Структура таблицы `vhabe_virtuemart_rating_reviews`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_rating_reviews` (
...
--
-- Структура таблицы `vhabe_virtuemart_rating_votes`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_rating_votes` (
...
--
-- Структура таблицы `vhabe_virtuemart_shipmentmethods`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_shipmentmethods` (
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0'
) ENGINE=MyISAM AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='Shipment created from the shipment plugins';

--
-- Дамп данных таблицы `vhabe_virtuemart_shipmentmethods`
--

INSERT INTO `vhabe_virtuemart_shipmentmethods` (`virtuemart_shipmentmethod_id`, `virtuemart_vendor_id`, `shipment_jplugin_id`, `shipment_element`, `shipment_params`, `currency_id`, `ordering`, `shared`, `published`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES
(1, 1, 10029, 'weight_countries', 'shipment_logos=""|show_on_pdetails="0"|categories=""|blocking_categories=""|countries=""|zip_start=""|zip_stop=""|weight_start=""|weight_stop=""|weight_unit="KG"|nbproducts_start=0|nbproducts_stop=0|orderamount_start=""|orderamount_stop=""|shipment_cost="400"|package_fee=""|tax_id="0"|free_shipment=""|', 131, 0, 0, 1, '2017-10-14 08:51:22', 413, '2017-10-14 08:52:38', 413, '0000-00-00 00:00:00', 0),
(3, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u041f\\u0440\\u043e\\u0441\\u0442\\u0430\\u044f\\u0411\\u0430\\u043d\\u0434\\u0435\\u0440\\u043e\\u043b\\u044c"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(4, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u0417\\u0430\\u043a\\u0430\\u0437\\u043d\\u0430\\u044f\\u0411\\u0430\\u043d\\u0434\\u0435\\u0440\\u043e\\u043b\\u044c"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""||postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(5, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u0426\\u0435\\u043d\\u043d\\u0430\\u044f\\u0411\\u0430\\u043d\\u0434\\u0435\\u0440\\u043e\\u043b\\u044c"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""||postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(6, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u0426\\u0435\\u043d\\u043d\\u0430\\u044f\\u0410\\u0432\\u0438\\u0430\\u0411\\u0430\\u043d\\u0434\\u0435\\u0440\\u043e\\u043b\\u044c"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""||postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(7, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u0417\\u0430\\u043a\\u0430\\u0437\\u043d\\u0430\\u044f\\u0411\\u0430\\u043d\\u0434\\u0435\\u0440\\u043e\\u043b\\u044c1\\u041a\\u043b\\u0430\\u0441\\u0441"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""||postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(8, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u0426\\u0435\\u043d\\u043d\\u0430\\u044f\\u0411\\u0430\\u043d\\u0434\\u0435\\u0440\\u043e\\u043b\\u044c1\\u041a\\u043b\\u0430\\u0441\\u0441"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""||postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(9, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u0426\\u0435\\u043d\\u043d\\u0430\\u044f\\u041f\\u043e\\u0441\\u044b\\u043b\\u043a\\u0430"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""||postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(10, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u0426\\u0435\\u043d\\u043d\\u0430\\u044f\\u0410\\u0432\\u0438\\u0430\\u041f\\u043e\\u0441\\u044b\\u043b\\u043a\\u0430"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""||postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(11, 1, 10044, 'postcalc', 'shipment_logos=["emspost.gif"]|postcalc_delivery="EMS"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""||postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(12, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u041c\\u0436\\u0434\\u041c\\u0435\\u0448\\u043e\\u043a\\u041c"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""|postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(13, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u041c\\u0436\\u0434\\u041c\\u0435\\u0448\\u043e\\u043a\\u041c\\u0417\\u0430\\u043a\\u0430\\u0437\\u043d\\u043e\\u0439"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""|postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(14, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u041c\\u0436\\u0434\\u041c\\u0435\\u0448\\u043e\\u043a\\u041c\\u0410\\u0432\\u0438\\u0430"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""|postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(15, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u041c\\u0436\\u0434\\u041c\\u0435\\u0448\\u043e\\u043a\\u041c\\u0410\\u0432\\u0438\\u0430\\u0417\\u0430\\u043a\\u0430\\u0437\\u043d\\u043e\\u0439"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""|postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(16, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u041c\\u0436\\u0434\\u0411\\u0430\\u043d\\u0434\\u0435\\u0440\\u043e\\u043b\\u044c"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""|postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(17, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u041c\\u0436\\u0434\\u0411\\u0430\\u043d\\u0434\\u0435\\u0440\\u043e\\u043b\\u044c\\u0417\\u0430\\u043a\\u0430\\u0437\\u043d\\u0430\\u044f"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""|postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(18, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u041c\\u0436\\u0434\\u0411\\u0430\\u043d\\u0434\\u0435\\u0440\\u043e\\u043b\\u044c\\u0410\\u0432\\u0438\\u0430"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""|postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(19, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u041c\\u0436\\u0434\\u0411\\u0430\\u043d\\u0434\\u0435\\u0440\\u043e\\u043b\\u044c\\u0410\\u0432\\u0438\\u0430\\u0417\\u0430\\u043a\\u0430\\u0437\\u043d\\u0430\\u044f"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""|postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(20, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u041c\\u0436\\u0434\\u041c\\u0435\\u043b\\u043a\\u0438\\u0439\\u041f\\u0430\\u043a\\u0435\\u0442"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""|postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(21, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u041c\\u0436\\u0434\\u041c\\u0435\\u043b\\u043a\\u0438\\u0439\\u041f\\u0430\\u043a\\u0435\\u0442\\u0417\\u0430\\u043a\\u0430\\u0437\\u043d\\u043e\\u0439"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""|postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(22, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u041c\\u0436\\u0434\\u041c\\u0435\\u043b\\u043a\\u0438\\u0439\\u041f\\u0430\\u043a\\u0435\\u0442\\u0410\\u0432\\u0438\\u0430"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""|postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(23, 1, 10044, 'postcalc', 'shipment_logos=["ruspost.gif"]|postcalc_delivery="\\u041c\\u0436\\u0434\\u041c\\u0435\\u043b\\u043a\\u0438\\u0439\\u041f\\u0430\\u043a\\u0435\\u0442\\u0410\\u0432\\u0438\\u0430\\u0417\\u0430\\u043a\\u0430\\u0437\\u043d\\u043e\\u0439"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""|postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(24, 1, 10044, 'postcalc', 'shipment_logos=["emspost.gif"]|postcalc_delivery="EMS_\\u041c\\u0436\\u0434\\u0422\\u043e\\u0432\\u0430\\u0440\\u044b"|postcalc_valuation="0"|postcalc_payment_forward="0"|postcalc_extra=""|postcalc_countries=""|postcalc_states=""|postcalc_except="0"|postcalc_weight_limit="1"|', NULL, 0, 0, 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_shipmentmethods_en_gb`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_shipmentmethods_en_gb` (
  `virtuemart_shipmentmethod_id` int(1) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_virtuemart_shipmentmethods_ru_ru`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_shipmentmethods_ru_ru` (
  `virtuemart_shipmentmethod_id` int(1) unsigned NOT NULL,
  `shipment_name` varchar(180) NOT NULL DEFAULT '',
  `shipment_desc` varchar(19000) NOT NULL DEFAULT '',
  `slug` varchar(192) NOT NULL DEFAULT ''
...
--
-- Дамп данных таблицы `vhabe_virtuemart_shipmentmethods_ru_ru`
--

INSERT INTO `vhabe_virtuemart_shipmentmethods_ru_ru` (`virtuemart_shipmentmethod_id`, `shipment_name`, `shipment_desc`, `slug`) VALUES
(1, 'Доставка курьером', 'Доставка курьером по городу', 'доставка-курьером'),
(3, 'Простая бандероль', 'Почта России', 'prostaya-banderol'),
(4, 'Заказная бандероль', 'Почта России', 'zakaznaya-banderol'),
(5, 'Ценная бандероль', 'Почта России', 'tsennaya-banderol'),
(6, 'Ценная авиабандероль', 'Почта России', 'tsennaya-aviabanderol'),
(7, 'Заказная бандероль 1 класса', 'Почта России', 'zakaznaya-banderol-1-klassa'),
(8, 'Ценная бандероль 1 класс', 'Почта России', 'tsennaya-banderol-1-klass'),
(9, 'Ценная посылка', 'Почта России', 'tsennaya-posylka'),
(10, 'Ценная авиапосылка', 'Почта России', 'tsennaya-aviaposylka'),
(11, 'Курьерская экспресс-доставка', 'EMS Почта России', 'kurerskaya-ekspress-dostavka'),
(12, 'Международный мешок М', 'Почта России', 'mezhdunarodnyj-meshok-m'),
(13, 'Международный заказной мешок М', 'Почта России', 'mezhdunarodnyj-zakaznoj-meshok-m'),
(14, 'Международный мешок М авиа-отправлением', 'Почта России', 'mezhdunarodnyj-meshok-m-avia-otpravleniem'),
(15, 'Международный заказной мешок М авиа-отправлением', 'Почта России', 'mezhdunarodnyj-zakaznoj-meshok-m-avia-otpravleniem'),
(16, 'Международная бандероль', 'Почта России', 'mezhdunarodnaya-banderol'),
(17, 'Международная заказная бандероль', 'Почта России', 'mezhdunarodnaya-zakaznaya-banderol'),
(18, 'Международная бандероль авиа-отправлением', 'Почта России', 'mezhdunarodnaya-banderol-avia-otpravleniem'),
(19, 'Международная заказная бандероль авиа-отправлением', 'Почта России', 'mezhdunarodnaya-zakaznaya-banderol-avia-otpravleniem'),
(20, 'Международный мелкий пакет', 'Почта России', 'mezhdunarodnyj-melkij-paket'),
(21, 'Международный заказной мелкий пакет', 'Почта России', 'mezhdunarodnyj-zakaznoj-melkij-paket'),
(22, 'Международный мелкий пакет авиа-отправлением', 'Почта России', 'mezhdunarodnyj-melkij-paket-avia-otpravleniem'),
(23, 'Международный заказной мелкий пакет авиа-отправлением', 'Почта России', 'mezhdunarodnyj-zakaznoj-melkij-paket-avia-otpravleniem'),
(24, 'Международная экспресс-доставка', 'EMS Почта России', 'mezhdunarodnaya-ekspress-dostavka');

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_shipmentmethod_shoppergroups`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_shipmentmethod_shoppergroups` (
  `id` int(1) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_virtuemart_shipment_plg_weight_countries`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_shipment_plg_weight_countries` (
  `id` int(1) unsigned NOT NULL,
...
--
-- Структура таблицы `vhabe_virtuemart_shoppergroups`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_shoppergroups` (
...
--
-- Дамп данных таблицы `vhabe_virtuemart_shoppergroups`
--

INSERT INTO `vhabe_virtuemart_shoppergroups` (`virtuemart_shoppergroup_id`, `virtuemart_vendor_id`, `shopper_group_name`, `shopper_group_desc`, `custom_price_display`, `price_display`, `default`, `sgrp_additional`, `ordering`, `shared`, `published`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES
(2, 1, 'COM_VIRTUEMART_SHOPPERGROUP_DEFAULT', 'COM_VIRTUEMART_SHOPPERGROUP_DEFAULT_TIP', 1, , 1, 0, 0, 1, 1, '0000-00-00 00:00:00', 0, '2017-10-14 08:06:20', 413, '0000-00-00 00:00:00', 0),
(1, 1, 'COM_VIRTUEMART_SHOPPERGROUP_GUEST', 'COM_VIRTUEMART_SHOPPERGROUP_GUEST_TIP', 0, , 2, 0, 0, 1, 1, '0000-00-00 00:00:00', 0, '2017-10-14 08:05:00', 413, '0000-00-00 00:00:00', 0),
(3, 1, 'Голд покупатели', 'Постоянные покупатели', 1, , 0, 0, 0, 0, 1, '2017-10-14 08:24:20', 413, '2017-10-14 08:40:31', 413, '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_states`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_states` (
...
--
-- Дамп данных таблицы `vhabe_virtuemart_states`
--

INSERT INTO `vhabe_virtuemart_states` (`virtuemart_state_id`, `virtuemart_vendor_id`, `virtuemart_country_id`, `virtuemart_worldzone_id`, `state_name`, `state_3_code`, `state_2_code`, `ordering`, `shared`, `published`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES
...
(570, 1, 176, 0, 'Адыгея Республика', 'AD', '01', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(571, 1, 176, 0, 'Алтай Республика', 'AL', '04', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(572, 1, 176, 0, 'Алтайский край', 'ALT', '22', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(573, 1, 176, 0, 'Амурская область', 'AMU', '28', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(574, 1, 176, 0, 'Архангельская область', 'ARK', '29', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(575, 1, 176, 0, 'Астраханская область', 'AST', '30', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(576, 1, 176, 0, 'Башкортостан Республика', 'BA', '02', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(577, 1, 176, 0, 'Белгородская область', 'BEL', '31', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(578, 1, 176, 0, 'Брянская область', 'BRY', '32', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(579, 1, 176, 0, 'Бурятия Республика', 'BU', '03', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(580, 1, 176, 0, 'Владимирская область', 'VLA', '33', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(581, 1, 176, 0, 'Волгоградская область', 'VGG', '34', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(582, 1, 176, 0, 'Вологодская область', 'VLG', '35', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(583, 1, 176, 0, 'Воронежская область', 'VOR', '36', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(584, 1, 176, 0, 'Дагестан Республика', 'DA', '05', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(585, 1, 176, 0, 'Еврейская автономная область', 'YEV', '79', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(586, 1, 176, 0, 'Забайкальский край', 'ZAB', '75', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(587, 1, 176, 0, 'Ивановская область', 'IVA', '37', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(588, 1, 176, 0, 'Ингушетия Республика', 'IN', '06', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(589, 1, 176, 0, 'Иркутская область', 'IRK', '38', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(590, 1, 176, 0, 'Кабардино-Балкарская Республика', 'KB', '07', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(591, 1, 176, 0, 'Калининградская область', 'KGD', '39', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(592, 1, 176, 0, 'Калмыкия Республика', 'KL', '08', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(593, 1, 176, 0, 'Калужская область', 'KLU', '40', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(594, 1, 176, 0, 'Камчатский край', 'KAM', '41', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(595, 1, 176, 0, 'Карачаево-Черкесская Республика', 'KC', '09', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(596, 1, 176, 0, 'Карелия Республика', 'KR', '10', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(597, 1, 176, 0, 'Кемеровская область', 'KEM', '42', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(598, 1, 176, 0, 'Кировская область', 'KIR', '43', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(599, 1, 176, 0, 'Коми Республика', 'KO', '11', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(600, 1, 176, 0, 'Костромская область', 'KOS', '44', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(601, 1, 176, 0, 'Краснодарский край', 'KDA', '23', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(602, 1, 176, 0, 'Красноярский край', 'KIA', '24', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(603, 1, 176, 0, 'Курганская область', 'KGN', '45', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(604, 1, 176, 0, 'Курская область', 'KRS', '46', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(605, 1, 176, 0, 'Ленинградская область', 'LEN', '47', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(606, 1, 176, 0, 'Липецкая область', 'LIP', '48', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(607, 1, 176, 0, 'Магаданская область', 'MAG', '49', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(608, 1, 176, 0, 'Марий Эл Республика', 'ME', '12', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(609, 1, 176, 0, 'Мордовия Республика', 'MO', '13', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
...
(612, 1, 176, 0, 'Мурманская область', 'MUR', '51', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(613, 1, 176, 0, 'Ненецкий автономный округ', 'NEN', '83', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(614, 1, 176, 0, 'Нижегородская область', 'NIZ', '52', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(615, 1, 176, 0, 'Новгородская область', 'NGR', '53', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(616, 1, 176, 0, 'Новосибирская область', 'NVS', '54', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(617, 1, 176, 0, 'Омская область', 'OMS', '55', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(618, 1, 176, 0, 'Оренбургская область', 'ORE', '56', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(619, 1, 176, 0, 'Орловская область', 'ORL', '57', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(620, 1, 176, 0, 'Пензенская область', 'PNZ', '58', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(621, 1, 176, 0, 'Пермский край', 'PER', '59', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(622, 1, 176, 0, 'Приморский край', 'PRI', '25', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(623, 1, 176, 0, 'Псковская область', 'PSK', '60', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(624, 1, 176, 0, 'Ростовская область', 'ROS', '61', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(625, 1, 176, 0, 'Рязанская область', 'RYA', '62', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(626, 1, 176, 0, 'Самарская область', 'SAM', '63', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(627, 1, 176, 0, 'Санкт-Петербург', 'SPE', '78', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(628, 1, 176, 0, 'Саратовская область', 'SAR', '64', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(629, 1, 176, 0, 'Саха (Якутия) Республика', 'SA', '14', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(630, 1, 176, 0, 'Сахалинская область', 'SAK', '65', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(631, 1, 176, 0, 'Свердловская область', 'SVE', '66', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(632, 1, 176, 0, 'Северная Осетия-Алания Республика', 'SE', '15', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(633, 1, 176, 0, 'Смоленская область', 'SMO', '67', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(634, 1, 176, 0, 'Ставропольский край', 'STA', '26', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(635, 1, 176, 0, 'Тамбовская область', 'TAM', '68', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(636, 1, 176, 0, 'Татарстан Республика', 'TA', '16', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(637, 1, 176, 0, 'Тверская область', 'TVE', '69', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(638, 1, 176, 0, 'Томская область', 'TOM', '70', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(639, 1, 176, 0, 'Тульская область', 'TUL', '71', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(640, 1, 176, 0, 'Тыва Республика', 'TY', '17', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(641, 1, 176, 0, 'Тюменская область', 'TYU', '72', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(642, 1, 176, 0, 'Удмуртская Республика', 'UD', '18', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(643, 1, 176, 0, 'Ульяновская область', 'ULY', '73', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(644, 1, 176, 0, 'Хакасия Республика', 'KK', '19', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(645, 1, 176, 0, 'Челябинская область', 'CHE', '74', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(646, 1, 176, 0, 'Чеченская Республика', 'CE', '20', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(647, 1, 176, 0, 'Чувашская Республика', 'CU', '21', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(648, 1, 176, 0, 'Чукотский автономный округ', 'CHU', '87', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(649, 1, 176, 0, 'Хабаровский край', 'KHA', '27', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(650, 1, 176, 0, 'Ханты-Мансийский автономный округ', 'KHM', '86', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(651, 1, 176, 0, 'Ямало-Ненецкий автономный округ', 'YAN', '89', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
(652, 1, 176, 0, 'Ярославская область', 'YAR', '76', 0, 1, 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 0),
...
--
-- Структура таблицы `vhabe_virtuemart_userfields`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_userfields` (
...
--
-- Структура таблицы `vhabe_virtuemart_userfield_values`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_userfield_values` (
...
--
-- Дамп данных таблицы `vhabe_virtuemart_userfield_values`
--

INSERT INTO `vhabe_virtuemart_userfield_values` (`virtuemart_userfield_value_id`, `virtuemart_userfield_id`, `fieldtitle`, `fieldvalue`, `sys`, `ordering`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES
...
--
-- Структура таблицы `vhabe_virtuemart_userinfos`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_userinfos` (
...
--
-- Структура таблицы `vhabe_virtuemart_vendors_ru_ru`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_vendors_ru_ru` (
  `virtuemart_vendor_id` int(1) unsigned NOT NULL,
  `vendor_store_desc` text NOT NULL,
  `vendor_terms_of_service` text NOT NULL,
  `vendor_legal_info` text NOT NULL,
...
--
-- Дамп данных таблицы `vhabe_virtuemart_vendors_ru_ru`
--

INSERT INTO `vhabe_virtuemart_vendors_ru_ru` (`virtuemart_vendor_id`, `vendor_store_desc`, `vendor_terms_of_service`, `vendor_legal_info`, `vendor_letter_css`, `vendor_letter_header_html`, `vendor_letter_footer_html`, `vendor_store_name`, `vendor_phone`, `vendor_url`, `metadesc`, `metakey`, `customtitle`, `vendor_invoice_free1`, `vendor_invoice_free2`, `vendor_mail_free1`, `vendor_mail_free2`, `vendor_mail_css`, `slug`) VALUES
(1, '<p> По всей видимости, недокуренный виски расширяет рыцаря. Базальтовый ксилофон бархатист. Бережная волчица философски настроена. Бетонный павиан напыщен и действует тактически. Имманентный крейсер мудр. Разумеется, выдра бархатиста. Радужный кадавр свободен и торжественен. Землистая мулатка шикарна и бархатиста. Конгруэнтная икра трансцендентальна. К своему удивлению мы замечаем, что название уверенного мартини трагически открывает драматичное будущее хомяка.</p>', '<p> Условия:</p>&#13;&#10;<h3>Конгруэнтная икра трансцендентальна</h3>&#13;&#10;<p>Неспроста свинцовый сосуд мгновенно открывает квазиупругую колбу. Карусель быстра и кратковременна. Часто бывает, что ядерная лапка груба и продуманна</p>', '<p> Права: Задумчивое довольствие миролюбиво. Экипаж груб. Далее мы видим, что заповедник исчерпывает кроликa. Будничное благополучие отрадно. Армада звездного букета эксцентрично поглядывает на букмекера скотоводства. Саксофон напыщен. Невероятно, но факт: миролюбивое стекло тайно забирается на освещение хрустального довольствия. Фруктовый перевал задумчив. Лунный паллиатив затаён и романтичен. Эксцентричная ящерица находит адекватную купюру.</p>', '', '', '', 'joomla интернет магазин', '', 'www.joomla', '', '', '', '', '', '', '', '', 'joomla-интернет-магазин');

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_vendor_medias`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_vendor_medias` (
  `id` int(1) unsigned NOT NULL,
  `virtuemart_vendor_id` int(1) unsigned NOT NULL DEFAULT '0',
  `virtuemart_media_id` int(1) unsigned NOT NULL DEFAULT '0',
  `ordering` int(1) NOT NULL DEFAULT '0'
...
--
-- Дамп данных таблицы `vhabe_virtuemart_vendor_medias`
--

INSERT INTO `vhabe_virtuemart_vendor_medias` (`id`, `virtuemart_vendor_id`, `virtuemart_media_id`, `ordering`) VALUES
(1, 1, 1, 1);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_vendor_users`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_vendor_users` (
  `id` int(1) unsigned NOT NULL,
  `virtuemart_vendor_id` int(1) unsigned NOT NULL DEFAULT '0',
  `virtuemart_user_id` int(1) unsigned NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Структура таблицы `vhabe_virtuemart_vmusers`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_vmusers` (
  `virtuemart_user_id` int(1) unsigned NOT NULL,
  `virtuemart_vendor_id` int(1) unsigned NOT NULL DEFAULT '0',
  ...
  `locked_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `locked_by` int(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB AUTO_INCREMENT=414 DEFAULT CHARSET=utf8 COMMENT='Holds the unique user data';

--
-- Дамп данных таблицы `vhabe_virtuemart_vmusers`
--

INSERT INTO `vhabe_virtuemart_vmusers` (`virtuemart_user_id`, `virtuemart_vendor_id`, `user_is_vendor`, `customer_number`, `virtuemart_paymentmethod_id`, `virtuemart_shipmentmethod_id`, `agreed`, `created_on`, `created_by`, `modified_on`, `modified_by`, `locked_on`, `locked_by`) VALUES
(413, 1, 1, 'AD21232f2', 0, 0, 0, '2017-10-13 12:02:38', 413, '2017-10-14 08:36:41', 413, '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_vmuser_shoppergroups`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_vmuser_shoppergroups` (
  `id` int(1) unsigned NOT NULL,
  `virtuemart_user_id` int(1) unsigned NOT NULL DEFAULT '0',
  `virtuemart_shoppergroup_id` int(1) unsigned NOT NULL DEFAULT '0'
...
--
-- Дамп данных таблицы `vhabe_virtuemart_vmuser_shoppergroups`
--

INSERT INTO `vhabe_virtuemart_vmuser_shoppergroups` (`id`, `virtuemart_user_id`, `virtuemart_shoppergroup_id`) VALUES
(1, 413, 3);

-- --------------------------------------------------------

--
-- Структура таблицы `vhabe_virtuemart_waitingusers`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_waitingusers` (
...
--
-- Структура таблицы `vhabe_virtuemart_worldzones`
--

CREATE TABLE IF NOT EXISTS `vhabe_virtuemart_worldzones` (
...
--
-- Структура таблицы `vhabe_wf_profiles`
--

CREATE TABLE IF NOT EXISTS `vhabe_wf_profiles` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `vhabe_wf_profiles`
--

INSERT INTO `vhabe_wf_profiles` (`id`, `name`, `description`, `users`, `types`, `components`, `area`, `device`, `rows`, `plugins`, `published`, `ordering`, `checked_out`, `checked_out_time`, `params`) VALUES
...
--
-- Индексы таблицы `vhabe_assets`
--
ALTER TABLE `vhabe_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `vhabe_associations`
--
ALTER TABLE `vhabe_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Индексы таблицы `vhabe_banners`
--
ALTER TABLE `vhabe_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `vhabe_banner_clients`
--
ALTER TABLE `vhabe_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Индексы таблицы `vhabe_banner_tracks`
--
ALTER TABLE `vhabe_banner_tracks`
...
--
-- Индексы таблицы `vhabe_categories`
--
ALTER TABLE `vhabe_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `vhabe_contact_details`
--
ALTER TABLE `vhabe_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Индексы таблицы `vhabe_content`
--
ALTER TABLE `vhabe_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Индексы таблицы `vhabe_contentitem_tag_map`
--
ALTER TABLE `vhabe_contentitem_tag_map`
...
--
-- Индексы таблицы `vhabe_content_frontpage`
--
ALTER TABLE `vhabe_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Индексы таблицы `vhabe_content_rating`
--
ALTER TABLE `vhabe_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Индексы таблицы `vhabe_content_types`
--
ALTER TABLE `vhabe_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Индексы таблицы `vhabe_extensions`
--
ALTER TABLE `vhabe_extensions`
...
--
-- Индексы таблицы `vhabe_fields`
--
ALTER TABLE `vhabe_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Индексы таблицы `vhabe_fields_categories`
--
ALTER TABLE `vhabe_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Индексы таблицы `vhabe_fields_groups`
--
ALTER TABLE `vhabe_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Индексы таблицы `vhabe_fields_values`
--
ALTER TABLE `vhabe_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Индексы таблицы `vhabe_finder_filters`
--
ALTER TABLE `vhabe_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Индексы таблицы `vhabe_finder_links`
--
ALTER TABLE `vhabe_finder_links`
...
--
-- Индексы таблицы `vhabe_finder_links_terms0`
--
ALTER TABLE `vhabe_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `vhabe_finder_links_terms1`
--
ALTER TABLE `vhabe_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `vhabe_finder_links_terms2`
--
ALTER TABLE `vhabe_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `vhabe_finder_links_terms3`
--
ALTER TABLE `vhabe_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `vhabe_finder_links_terms4`
--
ALTER TABLE `vhabe_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `vhabe_finder_links_terms5`
--
ALTER TABLE `vhabe_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `vhabe_finder_links_terms6`
--
ALTER TABLE `vhabe_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `vhabe_finder_links_terms7`
--
ALTER TABLE `vhabe_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `vhabe_finder_links_terms8`
--
ALTER TABLE `vhabe_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `vhabe_finder_links_terms9`
--
ALTER TABLE `vhabe_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `vhabe_finder_links_termsa`
--
ALTER TABLE `vhabe_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `vhabe_finder_links_termsb`
--
ALTER TABLE `vhabe_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `vhabe_finder_links_termsc`
--
ALTER TABLE `vhabe_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `vhabe_finder_links_termsd`
--
ALTER TABLE `vhabe_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `vhabe_finder_links_termse`
--
ALTER TABLE `vhabe_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `vhabe_finder_links_termsf`
--
ALTER TABLE `vhabe_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `vhabe_finder_taxonomy`
--
ALTER TABLE `vhabe_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `vhabe_finder_taxonomy_map`
--
ALTER TABLE `vhabe_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Индексы таблицы `vhabe_finder_terms`
--
ALTER TABLE `vhabe_finder_terms`
...
--
-- Индексы таблицы `vhabe_finder_terms_common`
--
ALTER TABLE `vhabe_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Индексы таблицы `vhabe_finder_tokens`
--
ALTER TABLE `vhabe_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Индексы таблицы `vhabe_finder_tokens_aggregate`
--
ALTER TABLE `vhabe_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Индексы таблицы `vhabe_finder_types`
--
ALTER TABLE `vhabe_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Индексы таблицы `vhabe_languages`
--
ALTER TABLE `vhabe_languages`
...
--
-- Индексы таблицы `vhabe_menu`
--
ALTER TABLE `vhabe_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `vhabe_menu_types`
--
ALTER TABLE `vhabe_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Индексы таблицы `vhabe_messages`
--
ALTER TABLE `vhabe_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Индексы таблицы `vhabe_messages_cfg`
--
ALTER TABLE `vhabe_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Индексы таблицы `vhabe_modules`
--
ALTER TABLE `vhabe_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `vhabe_modules_menu`
--
ALTER TABLE `vhabe_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Индексы таблицы `vhabe_newsfeeds`
--
ALTER TABLE `vhabe_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Индексы таблицы `vhabe_overrider`
--
ALTER TABLE `vhabe_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `vhabe_postinstall_messages`
--
ALTER TABLE `vhabe_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Индексы таблицы `vhabe_redirect_links`
--
ALTER TABLE `vhabe_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Индексы таблицы `vhabe_schemas`
--
ALTER TABLE `vhabe_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Индексы таблицы `vhabe_session`
--
ALTER TABLE `vhabe_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `userid` (`userid`),
  ADD KEY `time` (`time`);

--
-- Индексы таблицы `vhabe_tags`
--
ALTER TABLE `vhabe_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `vhabe_template_styles`
--
ALTER TABLE `vhabe_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Индексы таблицы `vhabe_ucm_base`
--
ALTER TABLE `vhabe_ucm_base`
...
--
-- Индексы таблицы `vhabe_ucm_content`
--
ALTER TABLE `vhabe_ucm_content`
...
--
-- Индексы таблицы `vhabe_ucm_history`
--
ALTER TABLE `vhabe_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Индексы таблицы `vhabe_updates`
--
ALTER TABLE `vhabe_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Индексы таблицы `vhabe_update_sites`
--
ALTER TABLE `vhabe_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Индексы таблицы `vhabe_update_sites_extensions`
--
ALTER TABLE `vhabe_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Индексы таблицы `vhabe_usergroups`
--
ALTER TABLE `vhabe_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `vhabe_users`
--
ALTER TABLE `vhabe_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `vhabe_user_keys`
--
ALTER TABLE `vhabe_user_keys`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `vhabe_user_notes`
--
ALTER TABLE `vhabe_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Индексы таблицы `vhabe_user_profiles`
--
ALTER TABLE `vhabe_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Индексы таблицы `vhabe_user_usergroup_map`
--
ALTER TABLE `vhabe_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Индексы таблицы `vhabe_viewlevels`
--
ALTER TABLE `vhabe_viewlevels`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_assetgroup_title_lookup` (`title`);

--
-- Индексы таблицы `vhabe_virtuemart_adminmenuentries`
--
ALTER TABLE `vhabe_virtuemart_adminmenuentries`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `vhabe_virtuemart_calcs`
--
ALTER TABLE `vhabe_virtuemart_calcs`
...
--
-- Индексы таблицы `vhabe_virtuemart_calc_categories`
--
ALTER TABLE `vhabe_virtuemart_calc_categories`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `virtuemart_calc_id` (`virtuemart_calc_id`,`virtuemart_category_id`);

--
-- Индексы таблицы `vhabe_virtuemart_calc_countries`
--
ALTER TABLE `vhabe_virtuemart_calc_countries`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `virtuemart_calc_id` (`virtuemart_calc_id`,`virtuemart_country_id`);

--
-- Индексы таблицы `vhabe_virtuemart_calc_manufacturers`
--
ALTER TABLE `vhabe_virtuemart_calc_manufacturers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `virtuemart_calc_id` (`virtuemart_calc_id`,`virtuemart_manufacturer_id`);

--
-- Индексы таблицы `vhabe_virtuemart_calc_shoppergroups`
--
ALTER TABLE `vhabe_virtuemart_calc_shoppergroups`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `virtuemart_calc_id` (`virtuemart_calc_id`,`virtuemart_shoppergroup_id`);

--
-- Индексы таблицы `vhabe_virtuemart_calc_states`
--
ALTER TABLE `vhabe_virtuemart_calc_states`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `virtuemart_calc_id` (`virtuemart_calc_id`,`virtuemart_state_id`);

--
-- Индексы таблицы `vhabe_virtuemart_carts`
--
ALTER TABLE `vhabe_virtuemart_carts`
  ADD PRIMARY KEY (`virtuemart_cart_id`),
  ADD KEY `virtuemart_vendor_id` (`virtuemart_vendor_id`),
  ADD KEY `virtuemart_user_id` (`virtuemart_user_id`);

--
-- Индексы таблицы `vhabe_virtuemart_categories`
--
ALTER TABLE `vhabe_virtuemart_categories`
...
--
-- Индексы таблицы `vhabe_virtuemart_categories_en_gb`
--
ALTER TABLE `vhabe_virtuemart_categories_en_gb`
  ADD PRIMARY KEY (`virtuemart_category_id`),
  ADD UNIQUE KEY `slug` (`slug`);

--
-- Индексы таблицы `vhabe_virtuemart_categories_ru_ru`
--
ALTER TABLE `vhabe_virtuemart_categories_ru_ru`
  ADD PRIMARY KEY (`virtuemart_category_id`),
  ADD UNIQUE KEY `slug` (`slug`);

--
-- Индексы таблицы `vhabe_virtuemart_category_categories`
--
ALTER TABLE `vhabe_virtuemart_category_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `vhabe_virtuemart_category_medias`
--
ALTER TABLE `vhabe_virtuemart_category_medias`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `vhabe_virtuemart_configs`
--
ALTER TABLE `vhabe_virtuemart_configs`
  ADD PRIMARY KEY (`virtuemart_config_id`);

--
-- Индексы таблицы `vhabe_virtuemart_countries`
--
ALTER TABLE `vhabe_virtuemart_countries`
...
--
-- Индексы таблицы `vhabe_virtuemart_coupons`
--
ALTER TABLE `vhabe_virtuemart_coupons`
...
--
-- Индексы таблицы `vhabe_virtuemart_currencies`
--
ALTER TABLE `vhabe_virtuemart_currencies`
...
--
-- Индексы таблицы `vhabe_virtuemart_customs`
--
ALTER TABLE `vhabe_virtuemart_customs`
...
--
-- Индексы таблицы `vhabe_virtuemart_invoices`
--
ALTER TABLE `vhabe_virtuemart_invoices`
...
--
-- Индексы таблицы `vhabe_virtuemart_manufacturercategories`
--
ALTER TABLE `vhabe_virtuemart_manufacturercategories`
  ADD PRIMARY KEY (`virtuemart_manufacturercategories_id`),
  ADD KEY `published` (`published`);

--
-- Индексы таблицы `vhabe_virtuemart_manufacturercategories_en_gb`
--
ALTER TABLE `vhabe_virtuemart_manufacturercategories_en_gb`
  ADD PRIMARY KEY (`virtuemart_manufacturercategories_id`),
  ADD UNIQUE KEY `slug` (`slug`);

--
-- Индексы таблицы `vhabe_virtuemart_manufacturercategories_ru_ru`
--
ALTER TABLE `vhabe_virtuemart_manufacturercategories_ru_ru`
  ADD PRIMARY KEY (`virtuemart_manufacturercategories_id`),
  ADD UNIQUE KEY `slug` (`slug`);

--
-- Индексы таблицы `vhabe_virtuemart_manufacturers`
--
ALTER TABLE `vhabe_virtuemart_manufacturers`
...
--
-- Индексы таблицы `vhabe_virtuemart_manufacturers_en_gb`
--
ALTER TABLE `vhabe_virtuemart_manufacturers_en_gb`
  ADD PRIMARY KEY (`virtuemart_manufacturer_id`),
  ADD UNIQUE KEY `slug` (`slug`);

--
-- Индексы таблицы `vhabe_virtuemart_manufacturers_ru_ru`
--
ALTER TABLE `vhabe_virtuemart_manufacturers_ru_ru`
  ADD PRIMARY KEY (`virtuemart_manufacturer_id`),
  ADD UNIQUE KEY `slug` (`slug`);

--
-- Индексы таблицы `vhabe_virtuemart_manufacturer_medias`
--
ALTER TABLE `vhabe_virtuemart_manufacturer_medias`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `virtuemart_manufacturer_id` (`virtuemart_manufacturer_id`,`virtuemart_media_id`),
  ADD KEY `ordering` (`ordering`);

--
-- Индексы таблицы `vhabe_virtuemart_medias`
--
ALTER TABLE `vhabe_virtuemart_medias`
...
--
-- Индексы таблицы `vhabe_virtuemart_migration_oldtonew_ids`
--
ALTER TABLE `vhabe_virtuemart_migration_oldtonew_ids`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `vhabe_virtuemart_modules`
--
ALTER TABLE `vhabe_virtuemart_modules`
...
--
-- Индексы таблицы `vhabe_virtuemart_orders`
--
ALTER TABLE `vhabe_virtuemart_orders`
...
--
-- Индексы таблицы `vhabe_virtuemart_orderstates`
--
ALTER TABLE `vhabe_virtuemart_orderstates`
...
--
-- Индексы таблицы `vhabe_virtuemart_order_calc_rules`
--
ALTER TABLE `vhabe_virtuemart_order_calc_rules`
...
--
-- Индексы таблицы `vhabe_virtuemart_order_histories`
--
ALTER TABLE `vhabe_virtuemart_order_histories`
  ADD PRIMARY KEY (`virtuemart_order_history_id`),
  ADD KEY `virtuemart_order_id` (`virtuemart_order_id`);

--
-- Индексы таблицы `vhabe_virtuemart_order_items`
--
ALTER TABLE `vhabe_virtuemart_order_items`
...
--
-- Индексы таблицы `vhabe_virtuemart_order_userinfos`
--
ALTER TABLE `vhabe_virtuemart_order_userinfos`
...
--
-- Индексы таблицы `vhabe_virtuemart_paymentmethods`
--
ALTER TABLE `vhabe_virtuemart_paymentmethods`
...
--
-- Индексы таблицы `vhabe_virtuemart_paymentmethods_en_gb`
--
ALTER TABLE `vhabe_virtuemart_paymentmethods_en_gb`
  ADD PRIMARY KEY (`virtuemart_paymentmethod_id`),
  ADD UNIQUE KEY `slug` (`slug`);

--
-- Индексы таблицы `vhabe_virtuemart_paymentmethods_ru_ru`
--
ALTER TABLE `vhabe_virtuemart_paymentmethods_ru_ru`
  ADD PRIMARY KEY (`virtuemart_paymentmethod_id`),
  ADD UNIQUE KEY `slug` (`slug`);

--
-- Индексы таблицы `vhabe_virtuemart_paymentmethod_shoppergroups`
--
ALTER TABLE `vhabe_virtuemart_paymentmethod_shoppergroups`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `virtuemart_paymentmethod_id` (`virtuemart_paymentmethod_id`,`virtuemart_shoppergroup_id`);

--
-- Индексы таблицы `vhabe_virtuemart_products`
--
ALTER TABLE `vhabe_virtuemart_products`
...
--
-- Индексы таблицы `vhabe_virtuemart_products_en_gb`
--
ALTER TABLE `vhabe_virtuemart_products_en_gb`
  ADD PRIMARY KEY (`virtuemart_product_id`),
  ADD UNIQUE KEY `slug` (`slug`);

--
-- Индексы таблицы `vhabe_virtuemart_products_ru_ru`
--
ALTER TABLE `vhabe_virtuemart_products_ru_ru`
  ADD PRIMARY KEY (`virtuemart_product_id`),
  ADD UNIQUE KEY `slug` (`slug`);

--
-- Индексы таблицы `vhabe_virtuemart_product_categories`
--
ALTER TABLE `vhabe_virtuemart_product_categories`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `virtuemart_product_id` (`virtuemart_product_id`,`virtuemart_category_id`),
  ADD KEY `ordering` (`ordering`);

--
-- Индексы таблицы `vhabe_virtuemart_product_customfields`
--
ALTER TABLE `vhabe_virtuemart_product_customfields`
...
--
-- Индексы таблицы `vhabe_virtuemart_product_manufacturers`
--
ALTER TABLE `vhabe_virtuemart_product_manufacturers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `virtuemart_product_id` (`virtuemart_product_id`,`virtuemart_manufacturer_id`);

--
-- Индексы таблицы `vhabe_virtuemart_product_medias`
--
ALTER TABLE `vhabe_virtuemart_product_medias`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `vhabe_virtuemart_product_prices`
--
ALTER TABLE `vhabe_virtuemart_product_prices`
...
--
-- Индексы таблицы `vhabe_virtuemart_product_shoppergroups`
--
ALTER TABLE `vhabe_virtuemart_product_shoppergroups`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `virtuemart_product_id` (`virtuemart_product_id`,`virtuemart_shoppergroup_id`);

--
-- Индексы таблицы `vhabe_virtuemart_ratings`
--
ALTER TABLE `vhabe_virtuemart_ratings`
  ADD PRIMARY KEY (`virtuemart_rating_id`),
  ADD UNIQUE KEY `virtuemart_product_id` (`virtuemart_product_id`,`virtuemart_rating_id`),
  ADD KEY `published` (`published`);

--
-- Индексы таблицы `vhabe_virtuemart_rating_reviews`
--
ALTER TABLE `vhabe_virtuemart_rating_reviews`
...
--
-- Индексы таблицы `vhabe_virtuemart_rating_votes`
--
ALTER TABLE `vhabe_virtuemart_rating_votes`
...
--
-- Индексы таблицы `vhabe_virtuemart_shipmentmethods`
--
ALTER TABLE `vhabe_virtuemart_shipmentmethods`
...
--
-- Индексы таблицы `vhabe_virtuemart_shipmentmethods_en_gb`
--
ALTER TABLE `vhabe_virtuemart_shipmentmethods_en_gb`
  ADD PRIMARY KEY (`virtuemart_shipmentmethod_id`),
  ADD UNIQUE KEY `slug` (`slug`);

--
-- Индексы таблицы `vhabe_virtuemart_shipmentmethods_ru_ru`
--
ALTER TABLE `vhabe_virtuemart_shipmentmethods_ru_ru`
  ADD PRIMARY KEY (`virtuemart_shipmentmethod_id`),
  ADD UNIQUE KEY `slug` (`slug`);

--
-- Индексы таблицы `vhabe_virtuemart_shipmentmethod_shoppergroups`
--
ALTER TABLE `vhabe_virtuemart_shipmentmethod_shoppergroups`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `virtuemart_shipmentmethod_id` (`virtuemart_shipmentmethod_id`,`virtuemart_shoppergroup_id`);

--
-- Индексы таблицы `vhabe_virtuemart_shipment_plg_weight_countries`
--
ALTER TABLE `vhabe_virtuemart_shipment_plg_weight_countries`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `vhabe_virtuemart_shoppergroups`
--
ALTER TABLE `vhabe_virtuemart_shoppergroups`
...
--
-- Индексы таблицы `vhabe_virtuemart_states`
--
ALTER TABLE `vhabe_virtuemart_states`
...
--
-- Индексы таблицы `vhabe_virtuemart_userfields`
--
ALTER TABLE `vhabe_virtuemart_userfields`
...
--
-- Индексы таблицы `vhabe_virtuemart_userfield_values`
--
ALTER TABLE `vhabe_virtuemart_userfield_values`
  ADD PRIMARY KEY (`virtuemart_userfield_value_id`),
  ADD KEY `virtuemart_userfield_id` (`virtuemart_userfield_id`);

--
-- Индексы таблицы `vhabe_virtuemart_userinfos`
--
ALTER TABLE `vhabe_virtuemart_userinfos`
...
--
-- Индексы таблицы `vhabe_virtuemart_vendors`
--
ALTER TABLE `vhabe_virtuemart_vendors`
  ADD PRIMARY KEY (`virtuemart_vendor_id`),
  ADD KEY `vendor_name` (`vendor_name`),
  ADD KEY `vendor_currency` (`vendor_currency`);

--
-- Индексы таблицы `vhabe_virtuemart_vendors_en_gb`
--
ALTER TABLE `vhabe_virtuemart_vendors_en_gb`
  ADD PRIMARY KEY (`virtuemart_vendor_id`),
  ADD UNIQUE KEY `slug` (`slug`);

--
-- Индексы таблицы `vhabe_virtuemart_vendors_ru_ru`
--
ALTER TABLE `vhabe_virtuemart_vendors_ru_ru`
  ADD PRIMARY KEY (`virtuemart_vendor_id`),
  ADD UNIQUE KEY `slug` (`slug`);

--
-- Индексы таблицы `vhabe_virtuemart_vendor_medias`
--
ALTER TABLE `vhabe_virtuemart_vendor_medias`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `virtuemart_vendor_id` (`virtuemart_vendor_id`,`virtuemart_media_id`);

--
-- Индексы таблицы `vhabe_virtuemart_vendor_users`
--
ALTER TABLE `vhabe_virtuemart_vendor_users`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `virtuemart_vendor_id` (`virtuemart_vendor_id`,`virtuemart_user_id`);

--
-- Индексы таблицы `vhabe_virtuemart_vmusers`
--
ALTER TABLE `vhabe_virtuemart_vmusers`
...
--
-- Индексы таблицы `vhabe_virtuemart_vmuser_shoppergroups`
--
ALTER TABLE `vhabe_virtuemart_vmuser_shoppergroups`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `virtuemart_user_id` (`virtuemart_user_id`,`virtuemart_shoppergroup_id`);

--
-- Индексы таблицы `vhabe_virtuemart_waitingusers`
--
ALTER TABLE `vhabe_virtuemart_waitingusers`
  ADD PRIMARY KEY (`virtuemart_waitinguser_id`),
  ADD KEY `virtuemart_product_id` (`virtuemart_product_id`),
  ADD KEY `notify_email` (`notify_email`);

--
-- Индексы таблицы `vhabe_virtuemart_worldzones`
--
ALTER TABLE `vhabe_virtuemart_worldzones`
  ADD PRIMARY KEY (`virtuemart_worldzone_id`),
  ADD KEY `virtuemart_vendor_id` (`virtuemart_vendor_id`);

--
-- Индексы таблицы `vhabe_wf_profiles`
--
ALTER TABLE `vhabe_wf_profiles`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `vhabe_assets`
--
ALTER TABLE `vhabe_assets`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=77;
--
-- AUTO_INCREMENT для таблицы `vhabe_banners`
--
ALTER TABLE `vhabe_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_banner_clients`
--
ALTER TABLE `vhabe_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_categories`
--
ALTER TABLE `vhabe_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT для таблицы `vhabe_contact_details`
--
ALTER TABLE `vhabe_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_content`
--
ALTER TABLE `vhabe_content`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `vhabe_content_types`
--
ALTER TABLE `vhabe_content_types`
  MODIFY `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT для таблицы `vhabe_extensions`
--
ALTER TABLE `vhabe_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10053;
--
-- AUTO_INCREMENT для таблицы `vhabe_fields`
--
ALTER TABLE `vhabe_fields`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_fields_groups`
--
ALTER TABLE `vhabe_fields_groups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_finder_filters`
--
ALTER TABLE `vhabe_finder_filters`
  MODIFY `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_finder_links`
--
ALTER TABLE `vhabe_finder_links`
  MODIFY `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_finder_taxonomy`
--
ALTER TABLE `vhabe_finder_taxonomy`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `vhabe_finder_terms`
--
ALTER TABLE `vhabe_finder_terms`
  MODIFY `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_finder_types`
--
ALTER TABLE `vhabe_finder_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_languages`
--
ALTER TABLE `vhabe_languages`
  MODIFY `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `vhabe_menu`
--
ALTER TABLE `vhabe_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=135;
--
-- AUTO_INCREMENT для таблицы `vhabe_menu_types`
--
ALTER TABLE `vhabe_menu_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT для таблицы `vhabe_messages`
--
ALTER TABLE `vhabe_messages`
  MODIFY `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_modules`
--
ALTER TABLE `vhabe_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=98;
--
-- AUTO_INCREMENT для таблицы `vhabe_newsfeeds`
--
ALTER TABLE `vhabe_newsfeeds`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_overrider`
--
ALTER TABLE `vhabe_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT для таблицы `vhabe_postinstall_messages`
--
ALTER TABLE `vhabe_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT для таблицы `vhabe_redirect_links`
--
ALTER TABLE `vhabe_redirect_links`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_tags`
--
ALTER TABLE `vhabe_tags`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `vhabe_template_styles`
--
ALTER TABLE `vhabe_template_styles`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT для таблицы `vhabe_ucm_content`
--
ALTER TABLE `vhabe_ucm_content`
  MODIFY `core_content_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_ucm_history`
--
ALTER TABLE `vhabe_ucm_history`
  MODIFY `version_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT для таблицы `vhabe_updates`
--
ALTER TABLE `vhabe_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT для таблицы `vhabe_update_sites`
--
ALTER TABLE `vhabe_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=37;
--
-- AUTO_INCREMENT для таблицы `vhabe_usergroups`
--
ALTER TABLE `vhabe_usergroups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT для таблицы `vhabe_users`
--
ALTER TABLE `vhabe_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=414;
--
-- AUTO_INCREMENT для таблицы `vhabe_user_keys`
--
ALTER TABLE `vhabe_user_keys`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_user_notes`
--
ALTER TABLE `vhabe_user_notes`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_viewlevels`
--
ALTER TABLE `vhabe_viewlevels`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_adminmenuentries`
--
ALTER TABLE `vhabe_virtuemart_adminmenuentries`
  MODIFY `id` tinyint(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=30;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_calcs`
--
ALTER TABLE `vhabe_virtuemart_calcs`
  MODIFY `virtuemart_calc_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_calc_categories`
--
ALTER TABLE `vhabe_virtuemart_calc_categories`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_calc_countries`
--
ALTER TABLE `vhabe_virtuemart_calc_countries`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_calc_manufacturers`
--
ALTER TABLE `vhabe_virtuemart_calc_manufacturers`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_calc_shoppergroups`
--
ALTER TABLE `vhabe_virtuemart_calc_shoppergroups`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_calc_states`
--
ALTER TABLE `vhabe_virtuemart_calc_states`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_carts`
--
ALTER TABLE `vhabe_virtuemart_carts`
  MODIFY `virtuemart_cart_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_categories`
--
ALTER TABLE `vhabe_virtuemart_categories`
  MODIFY `virtuemart_category_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_category_categories`
--
ALTER TABLE `vhabe_virtuemart_category_categories`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_category_medias`
--
ALTER TABLE `vhabe_virtuemart_category_medias`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_configs`
--
ALTER TABLE `vhabe_virtuemart_configs`
  MODIFY `virtuemart_config_id` tinyint(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_countries`
--
ALTER TABLE `vhabe_virtuemart_countries`
  MODIFY `virtuemart_country_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=249;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_coupons`
--
ALTER TABLE `vhabe_virtuemart_coupons`
  MODIFY `virtuemart_coupon_id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_currencies`
--
ALTER TABLE `vhabe_virtuemart_currencies`
  MODIFY `virtuemart_currency_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=202;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_customs`
--
ALTER TABLE `vhabe_virtuemart_customs`
  MODIFY `virtuemart_custom_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_invoices`
--
ALTER TABLE `vhabe_virtuemart_invoices`
  MODIFY `virtuemart_invoice_id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_manufacturercategories`
--
ALTER TABLE `vhabe_virtuemart_manufacturercategories`
  MODIFY `virtuemart_manufacturercategories_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_manufacturers`
--
ALTER TABLE `vhabe_virtuemart_manufacturers`
  MODIFY `virtuemart_manufacturer_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_manufacturer_medias`
--
ALTER TABLE `vhabe_virtuemart_manufacturer_medias`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_medias`
--
ALTER TABLE `vhabe_virtuemart_medias`
  MODIFY `virtuemart_media_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=22;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_migration_oldtonew_ids`
--
ALTER TABLE `vhabe_virtuemart_migration_oldtonew_ids`
  MODIFY `id` smallint(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_modules`
--
ALTER TABLE `vhabe_virtuemart_modules`
  MODIFY `module_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_orders`
--
ALTER TABLE `vhabe_virtuemart_orders`
  MODIFY `virtuemart_order_id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_orderstates`
--
ALTER TABLE `vhabe_virtuemart_orderstates`
  MODIFY `virtuemart_orderstate_id` tinyint(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_order_calc_rules`
--
ALTER TABLE `vhabe_virtuemart_order_calc_rules`
  MODIFY `virtuemart_order_calc_rule_id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_order_histories`
--
ALTER TABLE `vhabe_virtuemart_order_histories`
  MODIFY `virtuemart_order_history_id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_order_items`
--
ALTER TABLE `vhabe_virtuemart_order_items`
  MODIFY `virtuemart_order_item_id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_order_userinfos`
--
ALTER TABLE `vhabe_virtuemart_order_userinfos`
  MODIFY `virtuemart_order_userinfo_id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_paymentmethods`
--
ALTER TABLE `vhabe_virtuemart_paymentmethods`
  MODIFY `virtuemart_paymentmethod_id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_paymentmethod_shoppergroups`
--
ALTER TABLE `vhabe_virtuemart_paymentmethod_shoppergroups`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_products`
--
ALTER TABLE `vhabe_virtuemart_products`
  MODIFY `virtuemart_product_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_product_categories`
--
ALTER TABLE `vhabe_virtuemart_product_categories`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_product_customfields`
--
ALTER TABLE `vhabe_virtuemart_product_customfields`
  MODIFY `virtuemart_customfield_id` int(1) unsigned NOT NULL AUTO_INCREMENT COMMENT 'field id';
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_product_manufacturers`
--
ALTER TABLE `vhabe_virtuemart_product_manufacturers`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_product_medias`
--
ALTER TABLE `vhabe_virtuemart_product_medias`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_product_prices`
--
ALTER TABLE `vhabe_virtuemart_product_prices`
  MODIFY `virtuemart_product_price_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_product_shoppergroups`
--
ALTER TABLE `vhabe_virtuemart_product_shoppergroups`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_ratings`
--
ALTER TABLE `vhabe_virtuemart_ratings`
  MODIFY `virtuemart_rating_id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_rating_reviews`
--
ALTER TABLE `vhabe_virtuemart_rating_reviews`
  MODIFY `virtuemart_rating_review_id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_rating_votes`
--
ALTER TABLE `vhabe_virtuemart_rating_votes`
  MODIFY `virtuemart_rating_vote_id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_shipmentmethods`
--
ALTER TABLE `vhabe_virtuemart_shipmentmethods`
  MODIFY `virtuemart_shipmentmethod_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=25;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_shipmentmethod_shoppergroups`
--
ALTER TABLE `vhabe_virtuemart_shipmentmethod_shoppergroups`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_shipment_plg_weight_countries`
--
ALTER TABLE `vhabe_virtuemart_shipment_plg_weight_countries`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_shoppergroups`
--
ALTER TABLE `vhabe_virtuemart_shoppergroups`
  MODIFY `virtuemart_shoppergroup_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_states`
--
ALTER TABLE `vhabe_virtuemart_states`
  MODIFY `virtuemart_state_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=859;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_userfields`
--
ALTER TABLE `vhabe_virtuemart_userfields`
  MODIFY `virtuemart_userfield_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=52;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_userfield_values`
--
ALTER TABLE `vhabe_virtuemart_userfield_values`
  MODIFY `virtuemart_userfield_value_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_userinfos`
--
ALTER TABLE `vhabe_virtuemart_userinfos`
  MODIFY `virtuemart_userinfo_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_vendors`
--
ALTER TABLE `vhabe_virtuemart_vendors`
  MODIFY `virtuemart_vendor_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_vendor_medias`
--
ALTER TABLE `vhabe_virtuemart_vendor_medias`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_vendor_users`
--
ALTER TABLE `vhabe_virtuemart_vendor_users`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_vmusers`
--
ALTER TABLE `vhabe_virtuemart_vmusers`
  MODIFY `virtuemart_user_id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=414;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_vmuser_shoppergroups`
--
ALTER TABLE `vhabe_virtuemart_vmuser_shoppergroups`
  MODIFY `id` int(1) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_waitingusers`
--
ALTER TABLE `vhabe_virtuemart_waitingusers`
  MODIFY `virtuemart_waitinguser_id` int(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_virtuemart_worldzones`
--
ALTER TABLE `vhabe_virtuemart_worldzones`
  MODIFY `virtuemart_worldzone_id` smallint(1) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `vhabe_wf_profiles`
--
ALTER TABLE `vhabe_wf_profiles`
